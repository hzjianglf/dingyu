...
<div class="msgannounce" id="msgannounce" style="display: none;">
  ...
  <div class="msgextra expandablesection collapsed" id="child_extramessages">
    <p id="errorExtraContent"></p>
			...
			<!-- Breadcrumb trail -->
			<h3 class="breadcrumb" id="title-bread-crumb">服务注册</h3>
			
			<a name="main"></a>
		  <p id="detailviewdescription">
		    	在该页面增加所要注册的服务以及相对应的服务元数据。
		  </p>
		  <p id="errormsg" style="color:Red;font-weight:bold"></p>
  		<p>
   			<span style="color:Red;font-weight:bold"><s:property value="result"/></span>
  		</p>
...
<table class="detailcontenttable fixedlayout" border="0" cellpadding="0" cellspacing="0" id="detailcontenttable">  
  ...
  <tr>
    <td colspan="20">
      ...
      <form name="createbusinessservice" method="post" action="submitbusinessservice.action" id="createbusinessservice">
        ...
        <div class="propertiessection" id="propertiessection">
          ...
          <div class="expandablesection expanded" id="child_propSection0">
	            <div class="readonlyproperty notmandatory" id="prop_0">
	              <label for="servicename" title="调用的业务服务名称。" id="label_0">
	                业务服务名称
	              </label>            
	              <br/>
	
	              <input type="text" name="servicename" id="servicename" title="调用的业务服务名称。" tabindex="1" />    		  	     
	            </div>
	            
	            <div class="readonlyproperty notmandatory" id="prop_7">
	              <label for="" title="操作名称。" id="label_5">
	                	操作名称
	              </label>            
	              <br/>
	
	              <input type="text" name="operation" id="operation" title="操作名称." tabindex="1" />
	            </div>	
	            	            
    
	            <div class="readonlyproperty notmandatory" id="prop_1">
	              <label for="flowname" title="业务服务Endpoint URL地址。" id="label_1">
	                业务服务Endpoint
	              </label>            
	              <br/>
	
	              <input type="text" name="endpoint" id="endpoint" title="业务服务Endpoint." tabindex="1" />
	            </div>

	            <div class="readonlyproperty notmandatory" id="prop_2">
	              <label for="description" title="业务服务详细描述。" id="label_2">
	                描述
	              </label>            
	              <br/>
	
	              <input type="text" name="description" id="description" title="业务服务详细描述。" tabindex="1" />
	            </div>
	            
	            <div class="readonlyproperty notmandatory" id="prop_3">
	              <label for="" title="标记。" id="label_3">
	                Flag
	              </label>            
	              <br/>
	
	              <input type="text" name="flag" id="flag" title="服务标记." tabindex="1" />
	            </div>	 
	            
	            <div class="readonlyproperty notmandatory" id="prop_4">
	              <label for="" title="服务可用状态。" id="label_4">
	                	服务可用状态
	              </label>            
	              <br/>
...
<!--	              <input type="text" name="available" id="available" title="服务可用状态." tabindex="1" />-->
	            </div>		     
	            
	            <div class="readonlyproperty notmandatory" id="prop_5">
	              <label for="" title="服务是否上线。" id="label_5">
	                	服务是否上线
	              </label>            
	              <br/>
...
<!--	              <input type="text" name="onLine" id="onLine" title="服务是否上线." tabindex="1" />-->
	            </div>	
	            
	            
	            <div class="readonlyproperty notmandatory" id="prop_6">
	              <label for="" title="服务映射名称。" id="label_5">
	                	服务映射名称
	              </label>            
	              <br/>
	
	              <input type="text" name="mappingname" id="mappingname" title="服务映射名称." tabindex="1" />
	            </div>		            		                              
        ...
        <div class="buttongroup">
	        ...
	        <span id="primarybuttons">
	          <input type="submit" name="submit" value="创建" class="standardbutton" id="navigationsubmit" tabindex="1"/>	          
	        </span>
					&nbsp;&nbsp;
     ...
     <!-- WSDL导入 -->      	          
     <s:form action="uploadwsdlfile.action" method="post" enctype="multipart/form-data" theme="simple">
        ...
        <div class="propertiessection" id="propertiessection">
          ...
          <div class="expandablesection expanded" id="child_propSection0">
	            <div class="readonlyproperty notmandatory" id="prop_0">
	              ...
	              <input type="text" name="servicename" id="servicename" title="调用的业务服务名称。" tabindex="1" value="<s:property value="servicename"/>"/>    		  	     
	            </div>
    
	            <div class="readonlyproperty notmandatory" id="prop_1">
	              <label for="flowname" title="业务服务对应的消息流名称。" id="label_1">
	                消息流名称
	              </label>            
	              <br/>
	
	              <input type="text" name="flowname" id="flowname" title="业务服务对应的消息流名称。" tabindex="1" value="<s:property value="flowname"/>"/>
	            </div>
	            ...
	            <div class="readonlyproperty notmandatory" id="prop_2">
	              ...
	              <input type="text" name="description" id="description" title="业务服务详细描述。" tabindex="1"  value="<s:property value="description"/>"/>
	            </div>

							<div class="readonlyproperty notmandatory" id="prop_3">	
              	<label for="fileBrowser" title="指定WSDL文件的标准路径。使用“浏览”按钮可从文件选择对话框中选择文件。" id="label_3">
              		请指定WSDL文件路径
              	</label>
								<br/>
									
								<s:file name="imgFile" size="70" tabindex="1" value="" class="fileUpload" id="fileBrowser" />      
							</div>	
					    ...
					    <div class="buttongroup">
					      <s:submit name="apply" value="导入" class="standardbutton" id="navigationapply" style="background:#EAF1FF;width:38px" />				                
					      &nbsp;&nbsp;
					      <s:reset name="reset" value="重设" class="standardbutton" id="reset" style="background:#EAF1FF;width:38px" />				                
					    </div>
