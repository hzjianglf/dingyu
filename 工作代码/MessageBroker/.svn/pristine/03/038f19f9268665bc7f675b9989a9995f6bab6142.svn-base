...
<div class="portlet mainwindow" id="collectionview">
  <h2>
    ...
    <span id="collectionviewheading">查看执行组参数</span>
  </h2>
  ...
  <div class="portletbody" id="collectionviewbody">
    <div class="mediumpad" id="collectionviewbodypadding">
			...
			<!-- Breadcrumb trail -->
			<h3 class="breadcrumb" id="title-bread-crumb">执行组参数</h3>
					<a name="main"></a>
      		<p>
       				用户可以查看到代理 <span style="color:Green;font-weight:bold"><s:property value="brokername"/></span> 上执行组 <span style="color:Green;font-weight:bold"><s:property value="egname"/></span> 相关配置参数。
      		</p>
      		<br/>
		  		<p>
					...
					<form name="viewruntimeparam" method="post" action="" id="com.ibm.sr.ui.forms.CollectionForm">
							...
							<script language="javascript">  
									...
									function modifyruntime(){  
										...
										if (close) {										                     
									   		document.viewruntimeparam.action="submitruntimeexecutiongroup.action";  
									   		document.viewruntimeparam.submit();
										} 
									}							 								 	  
