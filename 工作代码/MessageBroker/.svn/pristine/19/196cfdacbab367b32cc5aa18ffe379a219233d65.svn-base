...
<script language="javascript">
	...
	function queryBroker(qmgrname){ 			
			document.displaysysteminfo.action="getsysteminfo.action?qmgrname=" + qmgrname;  
		  document.displaysysteminfo.submit();
	}  
...
<div class="portlet mainwindow" id="collectionview">
  <h2>
    ...
    <span id="collectionviewheading">系统资源监控</span>
  </h2>
  ...
  <div class="portletbody" id="collectionviewbody">
    <div class="mediumpad" id="collectionviewbodypadding">
			...
			<!-- Breadcrumb trail -->
			<h3 class="breadcrumb" id="title-bread-crumb">系统资源</h3>
					<a name="main"></a>
      		<p>
       				用户可以查看消息代理服务器的系统资源情况。
      		</p>
      		<div id="maincontainer" >
					
					<br/>
					<!-- 展现表格主表 main form -->
					<form name="displaysysteminfo" method="post" action="getsysteminfo.action" id="com.ibm.sr.ui.forms.CollectionForm">
	            ...
	            <br/>
							<s:iterator value="sysList" id="system"> 									
							<fieldset id="thepath" title="查看系统资源占用情况">
								<legend title="CPU基本信息">CPU基本信息</legend>
									<!-- 展现表格 results table -->
						              ...
						              <th width="5%">												
						               ...
						               <th width="3%">												
												...
												<tr>
													...
													<td><s:property value="mhz" /></td>
													<td><s:property value="totalCPUs" /></td>													
		              			</tr>								    
	          		...
	          		<fieldset id="thepath" title="查看CPU资源占用情况">
									<legend title="CPU使用率">CPU使用率</legend>							
						          ...
						          <table id="collection-table" class="collectiontable" cellspacing="1" cellpadding="0" border="0" summary="列表">
						            <tr>
						              ...
						              <th width="12%">
												...
												<tr>
													<td><s:property value="usertime" /></td>
													
													<s:if test="systime > '60.0%'"> 
															<td><span style="color:Red"><s:property value="systime" /></span></td>
													</s:if>
													<s:elseif test="cpurate > '40.0%'">
															<td><span style="color:Blue"><s:property value="systime" /></span></td>
													</s:elseif>														
													<s:else>
															<td><span style="color:Green"><s:property value="systime" /></span></td>														
													</s:else>
														
													<td><s:property value="idletime" /></td>
													<td><s:property value="waittime" /></td>														
													<td><s:property value="nicetime" /></td>
													
													<s:if test="combined > '60.0%'"> 
															<td><span style="color:Red"><s:property value="combined" /></span></td>
													</s:if>
													<s:elseif test="cpurate > '40.0%'">
															<td><span style="color:Blue"><s:property value="combined" /></span></td>
													</s:elseif>														
													<s:else>
															<td><span style="color:Green"><s:property value="combined" /></span></td>														
													</s:else>
																										
													<td><s:property value="irqtime" /></td>																																					
			              		</tr>								   
							      		<script type="text/javascript">								
													setRowStyles();
												</script>
								...
								<fieldset id="thepath" title="查看系统内存占用情况">
									<legend title="系统内存信息">内存信息</legend>
										<!-- 展现表格 results table -->
										<div class="widthalign horizontalscroll">
							          <table id="collection-table" class="collectiontable" cellspacing="1" cellpadding="0" border="0" summary="列表">
							            <tr>
							              ...
							              <th width="30%">												
					  							...
					  							<s:iterator value="#system.memList" status="stat"> 
														<tr>
