...
<div class="msgannounce" id="msgannounce" style="display: none;">
  ...
  <div class="msgextra expandablesection collapsed" id="child_extramessages">
    <p id="errorExtraContent"></p>
			...
			<!-- Breadcrumb trail -->
			<h3 class="breadcrumb" id="title-bread-crumb">用户注册</h3>
  		...
  		<p>
   			<span style="color:Red;font-weight:bold"><s:property value="comment"/></span>
  		</p>
...
function handleSubmit(evt)
{
  ...
  <tr>
    <td colspan="20">
      <form name="RegistryForm" method="post" action="registryuser.action" id="RegistryForm" focus="username" onsubmit="return handleSubmit(event)">
        ...
        <div class="propertiessection" id="propertiessection">
          ...
          <div class="expandablesection expanded" id="child_propSection0">
	            <div class="readonlyproperty notmandatory" id="prop_0">
	              <label for="username" title="注册的用户名。" id="label_0">
	                用户名
	              </label>            
	              <br/>
	
	              <input type="text" name="username" id="username" title="所要注册的用户名" tabindex="1" onfocus="handleFocus()" onkeypress="return handleKeypress(event)"/>    		  	     
	            </div>
    
	            <div class="readonlyproperty notmandatory" id="prop_1">
	              <label for="password" title="用户登录的密码。" id="label_1">
	                密码
	              </label>            
	              <br/>
	
	              <input type="password" name="password" id="password" title="用户登录所使用的密码，密码长度在6-15位之间。" tabindex="1" />
	            </div>

	            <div class="readonlyproperty notmandatory" id="prop_1">
	              <label for="confirmpassword" title="用户登录的密码。" id="label_1">
	                密码确认
	              </label>            
	              <br/>
	
	              <input type="password" name="confirmpassword" id="confirmpassword" title="用户登录所使用的密码，密码长度在6-15位之间。" tabindex="1" />
	            </div>
	            
	            <div class="readonlyproperty notmandatory" id="prop_2">
	              <label for="groups" title="用户所在的组" id="label_2">
	                所在组
	              </label>            
	              <br/>
	              ...
	              <select name="groups" id="groups">
	              	...
	              	<option value="Administrators">管理员组</option>
									<option value="Users">用户组</option>
								</select>																												
	            </div>

	            <div class="readonlyproperty notmandatory" id="prop_3">
	              <label for="email" title="用户的邮箱地址" id="label_3">
	                Email地址
	              </label>            
	              <br/>
	
	              <input type="text" name="email" id="email" title="用户所使用的邮箱地址，为告警使用。" tabindex="1" />
	            </div>
        ...
        <div class="buttongroup">
	        ...
	        <span id="primarybuttons">
	          <input type="submit" name="submit" value="注册" class="standardbutton" id="navigationsubmit" tabindex="1"/>	          
	        </span>
					&nbsp;&nbsp;
...
<script type="text/javascript">
document.RegistryForm.username.focus()
</script>
