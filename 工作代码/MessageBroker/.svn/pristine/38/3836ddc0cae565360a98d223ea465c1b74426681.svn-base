...
<script type="text/javascript" src='scripts/navTree.js'></script>
          ...
          <div id="brokermanage" class="main-task">
                <a href="javascript:navToggle('brokermanage')" id="link_brokermanage" title="折叠" class="blacknounderline" tabindex="1">
                  <img id="img_brokermanage" src="theme/standard/images/expanded.gif" alt="折叠" title="折叠"/>
                  代理管理
      	        </a>
      		</div>
	      	<div id="child_brokermanage" class="nav-child-container expanded">
						<ul class="nav-child">		
						   <li>
	            	...
	            	<a href="javascript:navToggle('parametersetting')" id="link_parametersetting" title="折叠" class="blacknounderline" tabindex="1">
	              	<img id="img_parametersetting" src="theme/standard/images/expanded.gif" alt="折叠" title="折叠"/>
	              	参数设置
	            	</a>
	        		</div>
	        		<div id="child_parametersetting" class="sub-child-container expanded">
								<ul class="nav-child">
								   <li>
