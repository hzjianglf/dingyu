...
<jsp:include page="navtree2.jsp" flush="true" />
...
<script language="javascript">
	...
	function queryBroker(qmgrname){ 			
			document.displaybrokerinfo.action="getsysteminfo.action?qmgrname=" + qmgrname;  
		  document.displaybrokerinfo.submit();
	}  
...
<div class="portlet mainwindow" id="collectionview">
  <h2>
    ...
    <span id="collectionviewheading">代理资源监控</span>
  </h2>
  ...
  <div class="portletbody" id="collectionviewbody">
    <div class="mediumpad" id="collectionviewbodypadding">
			...
			<!-- Breadcrumb trail -->
			<h3 class="breadcrumb" id="title-bread-crumb">消息代理资源</h3>
					<a name="main"></a>
      		<p>
       				用户可以查看到消息代理本身所消耗的系统资源情况。
      		</p>
      		<div id="maincontainer">
					
					<br/>
					<!-- 展现表格主表 main form -->
					<form name="displaybrokerinfo" method="post" action="gerbrokerprocinfo.action" id="com.ibm.sr.ui.forms.CollectionForm">

							<div class="userchoice">
	  	          <label for="qmgrlist" title="选择所要部署代理所在的队列管理器。">请选择代理队列管理器</label>
		            <br/>
		            	<select name="selectedQmgr" id="selectedQmgr" onchange="queryBroker(this.options[this.options.selectedIndex].value)">
							...
							<fieldset id="thepath" title="查看代理资源占用情况">
								<legend title="代理资源信息">消息代理资源信息</legend>
									<!-- 展现表格 results table -->
									<div class="widthalign horizontalscroll">
						          <table width="90%" id="collection-table" class="collectiontable" cellspacing="1" cellpadding="0" border="0" summary="列表">
						            <tr>
									        <th width="4%">
									         		Alert
									        </th>
						              ...
						              <th width="31%">
				  							...
				  							<s:iterator value="brokerProcList" status="stat">				  							
				  								<s:if test="command.contains('DataFlowEngine')||command.contains('bip')">												
													<tr>
														<td><img src="theme/standard/images/level/alertlevel_<s:property value="alertlevel"/>.gif" width="14" height="14"/></td>
							              <s:if test="cpurate > '60.0%'"> 
									              <td><span style="color:Red"><s:property value="pid"/></span></td>
																<td><span style="color:Red"><s:property value="user"/></span></td>
																<td><span style="color:Red"><s:property value="stime"/></span></td>
																<td><span style="color:Red"><s:property value="size"/></span></td>
																<td><span style="color:Red"><s:property value="rss"/></span></td>
																<td><span style="color:Red"><s:property value="share"/></span></td>
																<td><span style="color:Red"><s:property value="state"/></span></td>
																<td><span style="color:Red"><s:property value="time"/></span></td>
																<td><span style="color:Red"><s:property value="cpurate"/></span></td>
																<td><span style="color:Red"><s:property value="command"/></span></td>
														</s:if>
														<s:elseif test="cpurate > '40.0%'">
									              <td><span style="color:Blue"><s:property value="pid"/></span></td>
																<td><span style="color:Blue"><s:property value="user"/></span></td>
																<td><span style="color:Blue"><s:property value="stime"/></span></td>
																<td><span style="color:Blue"><s:property value="size"/></span></td>
																<td><span style="color:Blue"><s:property value="rss"/></span></td>
																<td><span style="color:Blue"><s:property value="share"/></span></td>
																<td><span style="color:Blue"><s:property value="state"/></span></td>
																<td><span style="color:Blue"><s:property value="time"/></span></td>
																<td><span style="color:Blue"><s:property value="cpurate"/></span></td>
																<td><span style="color:Blue"><s:property value="command"/></span></td>																	
														</s:elseif>															
														<s:else>
									              <td><span style="color:Green"><s:property value="pid"/></span></td>
																<td><span style="color:Green"><s:property value="user"/></span></td>
																<td><span style="color:Green"><s:property value="stime"/></span></td>
																<td><span style="color:Green"><s:property value="size"/></span></td>
																<td><span style="color:Green"><s:property value="rss"/></span></td>
																<td><span style="color:Green"><s:property value="share"/></span></td>
																<td><span style="color:Green"><s:property value="state"/></span></td>
																<td><span style="color:Green"><s:property value="time"/></span></td>
																<td><span style="color:Green"><s:property value="cpurate"/></span></td>
																<td><span style="color:Green"><s:property value="command"/></span></td>															
														</s:else>	
			              			</tr>
			              			</s:if>						    
									    	</s:iterator>
			          				...
			          				<table width="90%" class="pagingtable" cellspacing="0" cellpadding="0" border="0" summary="用于显示页面调度功能的表">
			              					<td width="97%">&nbsp;&nbsp;&nbsp; 消息代理进程总数：<s:property value="brokerProcNum"/> &nbsp;&nbsp;&nbsp;</td>
			            				</tr>
			          				</table>
			          		</div> <!-- widthalign -->
								</fieldset> 
	          		...
	          		<fieldset id="thepath" title="查看MQ资源占用情况">
									<legend title="WMQ资源信息">WMQ资源信息</legend>							
										<!-- WMQ展现表格 results table -->
										<div class="widthalign horizontalscroll">
						          <table id="collection-table" class="collectiontable" cellspacing="1" cellpadding="0" border="0" summary="列表">
						            <tr>
						              ...
						              <th width="31%">
				  							...
				  							<s:iterator value="brokerProcList" status="stat"> 
				  								<s:if test="command.contains('amq')"> 		  	
													<tr>
														<td><img src="theme/standard/images/level/alertlevel_<s:property value="alertlevel"/>.gif" width="14" height="14"/></td>
							              <s:if test="cpurate > '60.0%'"> 
								              <td><span style="color:Red"><s:property value="pid"/></span></td>
			          				...
			          				<table class="pagingtable" cellspacing="0" cellpadding="0" border="0" summary="用于显示页面调度功能的表">
			              					<td width="97%">&nbsp;&nbsp;&nbsp; WMQ进程总数：<s:property value="mqProceNum"/> &nbsp;&nbsp;&nbsp;</td>
			            				</tr>
			          				</table>
			          		</div> <!-- widthalign -->
								</fieldset>         		
