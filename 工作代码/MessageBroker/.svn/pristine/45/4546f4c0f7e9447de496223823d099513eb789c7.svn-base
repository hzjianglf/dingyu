...
<!-- Breadcrumb trail -->
<h3 class="breadcrumb" id="title-bread-crumb">HTTP超时</h3>

<a name="main"></a>
	  <p id="detailviewdescription">
	    在该页面用户可以设置SOAPRequest或HTTPRequest超时时间。
	  </p>
...
<table class="detailcontenttable" border="0" cellpadding="0" cellspacing="0" id="detailcontenttable">  
  ...
  <tr>
    <td>
      <form name="sethttptimeout" method="post" action="" id="sethttptimeout" >
        ...
        <div class="propertiessection" id="propertiessection">
	          <fieldset id="datetimepreferences" title="设置控制参数">
	            ...
	            <div class="userchoice">
	  	          <label for="httptimeout" title="HTTPRequest超时时间">HTTPRequest超时时间</label>
		            <br/>
		            
								<input type="text" name="httptimeout" id="httptimeout" title="HTTPRequest超时时间" tabindex="1" value="<s:property value="httptimeout"/>"/>				      																		
	            </div>

	            <div class="userchoice">
	  	          <label for="soaptimeout" title="SOAPRequest超时时间">SOAPRequest超时时间</label>
		            <br/>
		            
								<input type="text" name="soaptimeout" id="soaptimeout" title="SOAPRequest超时时间" tabindex="1" value="<s:property value="soaptimeout"/>"/>				      																		
	            </div>
	            ...
	            <br/>	            	            	            								            	
				    ...
				    <div class="morespaceabove">				    	
				      <input type="button" name="save" value="保存" class="standardbutton" id="navigationapply2" onclick="saveHttpTimeout()"/>				                				      
				      <input type="reset" name="reset" value="重设" class="standardbutton" id="navigationapply1" />				      
						...
						<script language="javascript">
							...
							function saveHttpTimeout(){ 
									document.sethttptimeout.action="savehttptimeout.action";  
								  document.sethttptimeout.submit();
							}  
