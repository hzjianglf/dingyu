...
<div class="portlet mainwindow" id="collectionview">
  <h2>
    ...
    <span id="collectionviewheading">监控查询结果</span>
  </h2>
  ...
  <div class="portletbody" id="collectionviewbody">
    <div class="mediumpad" id="collectionviewbodypadding">
			...
			<!-- Breadcrumb trail -->
			<h3 class="breadcrumb" id="title-bread-crumb">监控查询结果</h3>
					<a name="main"></a>
      		<p>
       				根据条件查询到的消息流监控记录。
      		</p>
      		<div id="maincontainer">
		          ...
		          <div>
		          	<input type="hidden" name="rowsPerPage" id="rowsPerPage" value="<s:property value="rowsPerPage"/>">
								<input type="hidden" name="brokername" id="brokername" value="<s:property value="brokername"/>">
								<input type="hidden" name="flowname" id="flowname" value="<s:property value="flowname"/>">		          	
								<input type="hidden" name="startdate" id="startdate" value="<s:property value="startdate"/>">
								<input type="hidden" name="starttime" id="starttime" value="<s:property value="starttime"/>">
								<input type="hidden" name="enddate" id="enddate" value="<s:property value="enddate"/>">
								<input type="hidden" name="endtime" id="endtime" value="<s:property value="endtime"/>">
		          </div>
				          ...
				          <table id="collection-table" class="collectiontable" cellspacing="1" cellpadding="0" border="0" summary="列表">
				            <tr>
				              ...
				              <th width="10%">
										...
										<s:action name="searchbyproperty" executeResult="false"></s:action>
		  							<s:iterator value="pagePropertyList" status="stat">  
              					...
              					<td width="1%">
              							...
              							<s:elseif test="page==1">
		              						...
		              						<s:if test="totalPage>1">
				              					<td width="1%">
					              					<form name="CollectionForm" method="post" action="searchbyproperty.action?page=<s:property value="page+1"/>" id="com.ibm.sr.ui.forms.CollectionPagingForm">
					              							<div align="left">
																					<input type="hidden" name="rowsPerPage" id="rowsPerPage" value="<s:property value="rowsPerPage"/>">					              								
																					<input type="hidden" name="brokername" id="brokername" value="<s:property value="brokername"/>">
																					<input type="hidden" name="flowname" id="flowname" value="<s:property value="flowname"/>">							              								
