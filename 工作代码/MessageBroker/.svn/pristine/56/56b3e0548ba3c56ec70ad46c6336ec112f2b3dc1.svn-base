...
<div class="msgannounce" id="msgannounce" style="display: none;">
  ...
  <div class="msgextra expandablesection collapsed" id="child_extramessages">
    <p id="errorExtraContent"></p>
			...
			<!-- Breadcrumb trail -->
			<h3 class="breadcrumb" id="title-bread-crumb">创建服务操作映射</h3>
...
<table class="detailcontenttable fixedlayout" border="0" cellpadding="0" cellspacing="0" id="detailcontenttable">  
  ...
  <tr>
    <td colspan="20">
      <form name="submitoperation" method="post" action="submitoperation.action" id="submitoperation">
        ...
        <div class="propertiessection" id="propertiessection">
          ...
          <div class="expandablesection expanded" id="child_propSection0">
	            <div class="readonlyproperty notmandatory" id="prop_0">
	              ...
	              <input type="text" name="servicename" id="servicename" title="调用的业务服务名称。" value="<s:property value="servicename"/>" tabindex="1" disabled= "true"/>    		  	     
	            </div>
	            ...
	            <div class="readonlyproperty notmandatory" id="prop_1">
	              ...
	              <input type="text" name="flowname" id="flowname" title="业务服务对应的消息流名称。" value="<s:property value="flowname"/>" tabindex="1" disabled= "true"/>
	            </div>

	            <div class="readonlyproperty notmandatory" id="prop_2">
	              <label for="operation" title="服务中所含的操作名称。" id="label_2">
	                服务操作
	              </label>            
	              <br/>
	
	              <input type="text" name="operation" id="operation" title="业务服务对应的消息流名称。" tabindex="1" />
	            </div>

	            <div class="readonlyproperty notmandatory" id="prop_3">
	              <label for="mappingname" title="服务操作所映射的业务名称。" id="label_3">
	                映射名称
	              </label>            
	              <br/>
	
	              <input type="text" name="mappingname" id="mappingname" title="业务服务对应的消息流名称。" tabindex="1" />
	            </div>
	            
	            <div class="readonlyproperty notmandatory" id="prop_4">
	              <label for="description" title="服务操作映射详细描述。" id="label_4">
	                描述
	              </label>            
	              <br/>
