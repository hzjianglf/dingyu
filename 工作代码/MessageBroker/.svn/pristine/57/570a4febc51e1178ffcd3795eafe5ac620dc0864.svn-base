...
<div class="portlet mainwindow" id="collectionview">
  <h2>
    ...
    <span id="collectionviewheading">失败监控</span>
  </h2>
  ...
  <div class="portletbody" id="collectionviewbody">
    <div class="mediumpad" id="collectionviewbodypadding">
			...
			<!-- Breadcrumb trail -->
			<h3 class="breadcrumb" id="title-bread-crumb">运行失败记录</h3>
					<a name="main"></a>
      		<p>
       				用户查看消息流中运行失败的处理记录。
      		</p>
      		<div id="maincontainer">
		          ...
		          <div class="expandablesection collapsed" id="child_prefsSection">
					...
					<script language="javascript"> 
							function applyRow(){ 
								 ...
								 if (f_check_integer(rows)) {
							   		document.ApplyRow.action="updaterow4failure.action";  
					...
					<!-- 展现表格主表 main form -->
					<form name="CollectionForm" method="post" action="searchfailure.action" id="com.ibm.sr.ui.forms.CollectionForm">
				          ...
				          <table id="collection-table" class="collectiontable" cellspacing="1" cellpadding="0" border="0" summary="列表">
				            <tr>
				              ...
				              <th width="10%">
										...
										<s:action name="searchfailure" executeResult="false"></s:action>
		  							<s:iterator value="pageFailureList" status="stat">  
              					...
              					<td width="1%">             							
              							...
              							<s:elseif test="page==1">
              								&nbsp;&nbsp;&nbsp;&nbsp;
				              					...
				              					<td width="1%">
					              					<form name="CollectionForm" method="post" action="searchfailure.action?page=<s:property value="page+1"/>" id="com.ibm.sr.ui.forms.CollectionPagingForm">
					              							<div align="left">
					              									<input type="hidden" value="<s:property value="rowsPerPage"/>" name="rowsPerPage" id="rowsPerPage"/>
