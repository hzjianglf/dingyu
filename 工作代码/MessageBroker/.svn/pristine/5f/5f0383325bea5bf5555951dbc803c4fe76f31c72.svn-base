...
<div class="portlet mainwindow" id="collectionview">
  <h2>
    ...
    <span id="collectionviewheading">告警信息列表</span>
  </h2>
  ...
  <div class="portletbody" id="collectionviewbody">
    <div class="mediumpad" id="collectionviewbodypadding">
			...
			<!-- Breadcrumb trail -->
			<h3 class="breadcrumb" id="title-bread-crumb">告警信息</h3>
					<a name="main"></a>
      		<p>
       				查看当前产生的告警信息，告警采集时间的间隔为2分钟。
      		</p>
      		<br/>
		  		<p>
      		...
      		<div id="maincontainer">
					...
					<!-- 展现表格主表 main form -->
					<form name="listAlertInfo" method="post" action="" id="com.ibm.sr.ui.forms.CollectionForm">
				            ...
				            <tbody>
					            <tr>
					              <td>	
													<input type="button"  name="flushalert" value="刷新告警信息" class="standardbutton" id="functions1" tabindex="1" onclick="flushAlert()" />	
					              </td>
					            </tr>				
				            </tbody>
				          </table>
							...
							<script language="javascript">  
									...
									function flushAlert(){     	                
									   document.listAlertInfo.action="listalertinfo.action";  
									   document.listAlertInfo.submit();
									}     									
				          ...
				          <table id="collection-table" class="collectiontable" cellspacing="1" cellpadding="0" border="0" summary="列表">
				            <tr>
				            		<th width="4%">
		  							...
		  							<s:iterator value="pageAlertInfoList" status="stat">  
		  	
											<tr>
												<td><img src="theme/standard/images/alert_view.gif" width="14" height="14"/></td>	
	              				<td><s:property value="alertuuid"/></td>
	              				<td><span style="color:Blue"><s:property value="createtime"/></span></td>
              					...
              					<s:elseif test="conditionitem=='5'.toString()">
              							<td>外部服务不可用</td>
												...
												<td><s:property value="numberitem"/></td>
												<td><span style="color:Red"><s:property value="curcount"/></span></td>
												<s:if test="conditionitem=='1'.toString()"> 																		              				
	              						<td>消息总数大于&nbsp;<span style="color:Red"><s:property value="numberitem"/></span>&nbsp;	产生告警</td>
	              				</s:if>              							
              					<s:elseif test="conditionitem=='2'.toString()">
              							<td>错误总数大于&nbsp;<span style="color:Red"><s:property value="numberitem"/></span>&nbsp;	产生告警</td>
              					</s:elseif>
              					<s:elseif test="conditionitem=='3'.toString()">
              							<td>服务请求响应时间大于&nbsp;<span style="color:Red"><s:property value="numberitem"/></span>&nbsp;	毫秒产生告警</td>
              					</s:elseif>
              					<s:elseif test="conditionitem=='4'.toString()">
              							<td>服务提供响应时间大于&nbsp;<span style="color:Red"><s:property value="numberitem"/></span>&nbsp;	毫秒产生告警</td>
              					</s:elseif>
              					<s:elseif test="conditionitem=='5'.toString()">
              							<td>外部服务不可用，错误调用次数大于&nbsp;<span style="color:Red"><s:property value="numberitem"/></span></td>
              					</s:elseif>													              				             			              				           				
	              			</tr>								    
							    	</s:iterator>
					      		<script type="text/javascript">								
              					...
              					<td width="1%">
              							...
              							<s:elseif test="page==1">
		              						...
		              						<s:if test="totalPage>1">
				              					<td width="1%">
					              					<form name="CollectionForm" method="post" action="listalertinfo.action?page=<s:property value="page+1"/>" id="com.ibm.sr.ui.forms.CollectionPagingForm">
