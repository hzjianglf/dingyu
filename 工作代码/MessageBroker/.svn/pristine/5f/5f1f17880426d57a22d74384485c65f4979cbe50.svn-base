...
<!-- Breadcrumb trail -->
<h3 class="breadcrumb" id="title-bread-crumb">Socket超时</h3>

<a name="main"></a>
	  <p id="detailviewdescription">
	    在该页面用户可以设置TCPIPServer或TCPIPClient超时时间。
	  </p>
...
<table class="detailcontenttable" border="0" cellpadding="0" cellspacing="0" id="detailcontenttable">  
  ...
  <tr>
    <td>
      <form name="setsockettimeout" method="post" action="" id="setsockettimeout" >
      
        <div class="propertiessection" id="propertiessection">
	          <fieldset id="datetimepreferences" title="设置控制参数">
	            <legend title="设置控制参数">超时控制参数</legend>
            		           						
	            <div class="userchoice">
	  	          <label for="tcpipservertimeout" title="TCPIPServer超时时间">TCPIPServer超时时间</label>
		            <br/>
		            
								<input type="text" name="tcpipservertimeout" id="tcpipservertimeout" title="HTTPRequest超时时间" tabindex="1" value="<s:property value="tcpipservertimeout"/>"/>				      																		
	            </div>

	            <div class="userchoice">
	  	          <label for="tcpipclienttimeout" title="TCPIPClient超时时间">TCPIPClient超时时间</label>
		            <br/>
		            
								<input type="text" name="tcpipclienttimeout" id="tcpipclienttimeout" title="SOAPRequest超时时间" tabindex="1" value="<s:property value="tcpipclienttimeout"/>"/>				      																		
	            </div>
	            ...
	            <br/>	            	            	            								            	
				    ...
				    <div class="morespaceabove">				    	
				      <input type="button" name="save" value="保存" class="standardbutton" id="navigationapply2" onclick="saveSocketTimeout()"/>				                				      
				      <input type="reset" name="reset" value="重设" class="standardbutton" id="navigationapply1" />				      
						...
						<script language="javascript">
							...
							function saveSocketTimeout(){ 
									document.setsockettimeout.action="savesockettimeout.action";  
								  document.setsockettimeout.submit();
							}  
