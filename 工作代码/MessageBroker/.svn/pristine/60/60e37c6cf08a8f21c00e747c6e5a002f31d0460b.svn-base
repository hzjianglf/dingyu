...
<!-- Breadcrumb trail -->
<h3 class="breadcrumb" id="title-bread-crumb">服务请求查询</h3>

<a name="main"></a>
	  <p id="detailviewdescription">
	    在该页面用户可以根据服务名查询接口请求调用信息。
	  </p>
...
<table class="detailcontenttable fixedlayout" border="0" cellpadding="0" cellspacing="0" id="detailcontenttable">  
  ...
  <tr>
    <td colspan="20">
      <form name="queryservicerequest" method="post" id="queryservicerequest" action="">
        ...
        <div class="buttongroup">
	        ...
	        <span id="primarybuttons">
	        	<input type="button"  name="search" value="查询" class="standardbutton" id="functions1" tabindex="1" onclick="searchRequest()" />	
					...
					<script language="javascript"> 
							function searchRequest(){ 
								 ...
								 if (f_check_integer(rows)) {
							   		document.queryservicerequest.action="searchwsrequest.action";  
							   		document.queryservicerequest.submit();
							   } else {
							   		alert("请输入大于零的整数");
							   }			
							}																		
