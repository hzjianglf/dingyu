...
<!-- Breadcrumb trail -->
<h3 class="breadcrumb" id="title-bread-crumb">历史统计图表</h3>

<a name="main"></a>
	  <p id="detailviewdescription">
	    用户在该页面查看历史消息流数据汇总和分析图表。
	  </p>
...
<% 
  ...
  String strPie3D = (String)vs.findValue("chartBasePie3D");
  String strColumn3D = (String)vs.findValue("chartBaseColumn3D");                                                       
%>  
	
<form name="currentchart" method="post" action="gethistorycharts.action" id="currentchart">
    ...
    <td colspan="20">
        ...
        <div class="propertiessection" id="propertiessection">
          ...
          <div class="expandablesection expanded" id="child_propSection1">
	                ...
	                <jsp:param name="strURL" value="" />
	                <jsp:param name="strXML" value="<%=strColumn3D%>" />
        ...
        <div class="portletbody" id="helpwindowbody">
          <div class="mediumpad">
            ...
            <div id="pageHelpLink">
              ...
              <a href="ShowPageHelp.do?topic=detail.view.wsdl" title="查看该页面的更多相关信息（在新窗口中打开）" target="SR_help" tabindex="1">有关此页面的更多信息</a>
