...
<div class="portlet mainwindow" id="collectionview">
  <h2>
    ...
    <span id="collectionviewheading">IP访问控制</span>
  </h2>
  ...
  <div class="portletbody" id="collectionviewbody">
    <div class="mediumpad" id="collectionviewbodypadding">
			...
			<!-- Breadcrumb trail -->
			<h3 class="breadcrumb" id="title-bread-crumb">信任IP地址</h3>
					<a name="main"></a>
      		<p>
       				可以设置信任IP地位的范围，在此范围内的客户端可以访问ESB。
      		</p>
      		<div id="maincontainer">
					<br/>

					<!-- 展现表格主表 main form -->
					<form name="displaytrusted" method="post" action="" id="com.ibm.sr.ui.forms.CollectionForm">
				          ...
				          <table class="buttontable" cellspacing="0" cellpadding="0" border="0">				
				            <tbody>
					            <tr>
					              <td>													
					              	<input type="button"  name="create" value="创建信任地址" class="standardbutton" id="functions1" tabindex="1" onclick="createTrusted()" />
					              	<input type="button"  name="modify" value="修改信任地址" class="standardbutton" id="functions2" tabindex="1" onclick="modifyTrusted()" />													
					              	<input type="button"  name="delete" value="删除信任地址" class="standardbutton" id="functions3" tabindex="1" onclick="deleteTrusted()" />																	              	
					              </td>
					            </tr>
				            </tbody>
				          </table>
							...
							<script language="javascript">  		
									...
									function createTrusted(){                   
									   document.displaytrusted.action="createipaddress.action";  
									   document.displaytrusted.submit();
									}										

									function modifyTrusted(){                   
									   document.displaytrusted.action="modifyipaddress.action";  
									   document.displaytrusted.submit();
									}	
									
									function deleteTrusted(){ 
										 var close = confirm("确认删除路由信息？");
										 if (close) {
									   		document.displaytrusted.action="deleteipaddress.action";  
									   		document.displaytrusted.submit();
									   }		
									}																				 
							</script>
				            ...
				            <tr>
				              ...
				              <th width="39%" title="IP访问控制描述">												
		  							...
		  							<s:iterator value="pageTrustedList" status="stat">  		  	
											<tr>
					              <td width="1%">
										  	  <label class="collectionLabel" title="选择" for="<s:property value="tid"/>"/>
					             	  <input type="checkbox" name="selectedItemIds" tabindex="1" value="<s:property value="tid"/>" onclick="onItemSelected(this)" onkeypress="onItemSelected(this)" class="noborder nomargin" id="<s:property value="tid"/>" title="选择">
					              </td>
												<td><s:property value="startip"/></td>
              					...
              					<td width="1%">             							
              							...
              							<s:elseif test="page==1">
		              						...
		              						<s:if test="totalPage>1">
				              					<td width="1%">
					              					<form name="CollectionForm" method="post" action="displaytrusted.action?page=<s:property value="page+1"/>" id="com.ibm.sr.ui.forms.CollectionPagingForm">
					              							<div align="left">
