...
<a name="main"></a>
	  ...
	  <s:if test="operation=='controlbroker'">
				<s:iterator value="commentMap" id="cmtmap"> 
					<p id="detailviewdescription">
						<span style="color:Green;font-weight:bold"><s:property value="#cmtmap.value"/></span>
					</p>	
				</s:iterator>
	  </s:if>
	  <s:else>
    ...
    <div class="buttongroup">
      ...
      <span id="primarybuttons">
      	<s:if test="operation=='bkparametersetting'">
      	...
      	<s:elseif test="operation=='controlbroker'">
		      	<form name="return" method="post" action="listbrokers.action" id="com.ibm.sr.ui.forms.CollectionPrefsForm">	
							  <input type="submit" name="submit" value="返回代理列表" class="standardbutton" id="navigationsubmit" tabindex="1"/>	
		        </form>	
				</s:elseif>														
				<s:else>
