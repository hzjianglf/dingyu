...
dojo.provide("com.ibm.sr.widgets.DateSelector");
...
dojo.declare(
	"com.ibm.sr.widgets.DateSelector",
	[dijit._Widget, dijit._Templated],
	{
		/*
		summary:
			A popup for choosing a date and with a month to view calendar.
		...
		*/
		...
		templatePath: dojo.moduleUrl("com.ibm.sr.widgets.DateSelector", "DateSelector.html"),
		...
		dayWidth: "narrow",
		constraints:{selector:'date', formatLength:'full'},
		...
		_populateGrid: function(){
			...
			var typematic = function(nodeProp, dateProp, adj){
				...
				// if this gets fired, then no date is actually selected!
...
// this.onValueSelected(this.value);
		...
		this.dateValueNode.innerHTML = dojo.date.locale.format(this.dateValue, this.constraints);
