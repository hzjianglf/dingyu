...
<div class="portlet mainwindow" id="collectionview">
  <h2>
    ...
    <span id="collectionviewheading">修改信任IP地址范围</span>
  </h2>
  ...
  <div class="portletbody" id="collectionviewbody">
    <div class="mediumpad" id="collectionviewbodypadding">
			...
			<!-- Breadcrumb trail -->
			<h3 class="breadcrumb" id="title-bread-crumb">信任IP</h3>
					<a name="main"></a>
      		<p>
       				在该页面用户可以修改信任IP地址范围。
      		</p>     		
      		<div id="maincontainer">
					...
					<!-- 展现表格主表 main form -->
					<form name="modifytrusted" method="post" action="" id="com.ibm.sr.ui.forms.CollectionForm">
				          ...
				          <table class="buttontable" cellspacing="0" cellpadding="0" border="0">				
				            <tbody>
					            <tr>
					              <td>
					              	<input type="hidden" value="<s:property value="tid"/>" name="tid" id="tid"/>
							...
							<script language="javascript"> 
								 	function submitOperation(){ 
										 var close = confirm("确认修改IP地址范围？");
										 if (close) {
									   		document.modifytrusted.action="savemodifyipaddress.action";  
									   		document.modifytrusted.submit();
									   }		
									}	
																	
									function cancelOperation(){             
									   document.modifytrusted.action="permitipaddress.action";  
									   document.modifytrusted.submit();									   
									}	
				          ...
				          <table id="collection-table" class="collectiontable" cellspacing="1" cellpadding="0" border="0" summary="列表">
				            <tr>
				              ...
				              <th width="30%" title="起始IP地址">												
													起始IP地址																									
				              </th>
				               <th width="30%" title="结束IP地址">												
													结束IP地址												  
				              </th>
				              <th width="39%" title="IP访问控制描述">												
													描述									  
				              </th>			              				              		              
										</tr>
										
		  							<s:iterator value="pageTrustedList" status="stat">  
		  	
											<tr>
					              <td width="1%">
										  	  <label class="collectionLabel" title="选择" for="<s:property value="tid"/>" disabled="true" />
					             	  <input type="hidden" name="selectedItemIds" tabindex="1" value="<s:property value="tid"/>" onclick="onItemSelected(this)" onkeypress="onItemSelected(this)" class="noborder nomargin" id="<s:property value="tid"/>" title="选择">
					              </td>
												<td><input style="width:95%" type="text" value="<s:property value="startip"/>" name="startip" id="startip" tabindex="1" /></td>
	              				<td><input style="width:95%" type="text" value="<s:property value="endip"/>" name="endip" id="endip" tabindex="1" /></td>
