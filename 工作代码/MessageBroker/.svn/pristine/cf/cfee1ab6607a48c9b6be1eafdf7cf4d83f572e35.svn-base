...
<div class="msgannounce" id="msgannounce" style="display: none;">
  ...
  <div class="msgextra expandablesection collapsed" id="child_extramessages">
    <p id="errorExtraContent"></p>
			...
			<!-- Breadcrumb trail -->
			<h3 class="breadcrumb" id="title-bread-crumb">密码修改</h3>
...
<script type="text/javascript">
var TRANS_LOGON_ERROR="必须指定当前密码。";
...
function handleSubmit(evt)
{
  ...
  <tr>
    <td colspan="20">
      <form name="ModifyPassword" method="post" action="modifypassword.action" id="ModifyPassword" focus="password" onsubmit="return handleSubmit(event)">
        ...
        <div class="propertiessection" id="propertiessection">
          ...
          <div class="expandablesection expanded" id="child_propSection0">
	            <div class="readonlyproperty notmandatory" id="prop_0">
	              <label for="password" title="当前用户密码" id="label_0">
	                当前用户密码
	              </label>            
	              <br/>
	
	              <input type="password" name="password" id="password" title="用户当前的登录密码。" tabindex="1" onfocus="handleFocus()" onkeypress="return handleKeypress(event)"/>    		  	     
	            </div>
    
	            <div class="readonlyproperty notmandatory" id="prop_1">
	              <label for="newpassword" title="用户登录的新密码。" id="label_1">
	                新密码
	              </label>            
	              <br/>
	
	              <input type="password" name="newpassword" id="newpassword" title="用户登录所使用的新密码，密码长度在6-15位之间。" tabindex="1" />
	            </div>

	            <div class="readonlyproperty notmandatory" id="prop_1">
	              <label for="confirmpassword" title="确认用户登录的新密码。" id="label_1">
	                新密码确认
	              </label>            
	              <br/>
	
	              <input type="password" name="confirmpassword" id="confirmpassword" title="确认用户登录所使用的密码，密码长度在6-15位之间。" tabindex="1" />
	            </div>
        ...
        <div class="buttongroup">
	        ...
	        <span id="primarybuttons">
	          <input type="submit" name="submit" value="修改" class="standardbutton" id="navigationsubmit" tabindex="1"/>	          
	        </span>
					&nbsp;&nbsp;
