        ...
        <div class="propertiessection" id="propertiessection">
	          <fieldset id="datetimepreferences" title="设置所要控制的消息流">
	            <legend title="设置所要控制的消息流">设置所要控制的消息流</legend>
	              ...
	              <input type="text" name="flowname" id="flowname" title="填写所要进行流量控制的消息流名称。" tabindex="1" />
	            </div>	            		           						
	            ...
	            <div class="userchoice">
		            ...
		            <br/>
								...
								<input type="text" name="partofinterval" id="partofinterval" title="填写流量控制时间间隔。" tabindex="1" />				      																		
	            </div>
	            ...
	            <div class="userchoice">
	              ...
	              <select name="partofunit" id="partofunit">
	            ...
	            <div class="userchoice">
		            ...
		            <br/>
								...
								<input type="text" name="partofthreshold" id="partofthreshold" title="填写单个消息流的流量阈值。" tabindex="1" />				      																		
	            </div>
	            	            	            								            	
			      </fieldset>						       
									
				    <div class="morespaceabove">				    	
				      <input type="button" name="apply2" value="添加" class="standardbutton" id="navigationapply2" onclick="createConfigService()"/>				                				      
				      <input type="reset" name="apply1" value="重设" class="standardbutton" id="navigationapply1" />				      
						...
						<script language="javascript">  
								...
								function createConfigService(){     	                
								   document.partofcontrolsetting.action="savepartofcontrol.action";  
