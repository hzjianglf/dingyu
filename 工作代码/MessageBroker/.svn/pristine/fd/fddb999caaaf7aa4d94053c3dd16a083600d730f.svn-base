...
<script type="text/javascript" src='scripts/navTree.js'></script>
          ...
          <div id="slacontrol" class="main-task">
                <a href="javascript:navToggle('slacontrol')" id="link_slacontrol" title="展开" class="blacknounderline" tabindex="1">
                  <img id="img_slacontrol" src="theme/standard/images/expanded.gif" alt="展开" title="展开"/>
                  配置管理
      	        </a>
      		</div>
      		
					<div id="child_slacontrol" class="nav-child-container expanded">						

						<div id="route" class="sub-task">          
            	<a href="javascript:navToggle('route')" id="link_route" title="展开" class="blacknounderline" tabindex="1">
              	<img id="img_route" src="theme/standard/images/expanded.gif" alt="展开" title="展开"/>
              	路由管理
            	</a>
        		</div>        		
        		<div id="child_route" class="sub-child-container expanded">
							<ul class="nav-child">
        				<li>
            	...
            	<a href="javascript:navToggle('alert')" id="link_alert" title="展开" class="blacknounderline" tabindex="1">
              	<img id="img_alert" src="theme/standard/images/expanded.gif" alt="展开" title="展开"/>
              	告警信息
            	</a>
        		</div>
        		
        		<div id="child_alert" class="sub-child-container expanded">
							<ul class="nav-child">
        				<li>
            	...
            	<a href="javascript:navToggle('flowcontrol')" id="link_flowcontrol" title="展开" class="blacknounderline" tabindex="1">
              	<img id="img_flowcontrol" src="theme/standard/images/expanded.gif" alt="展开" title="展开"/>
              	流量控制
            	</a>
        		</div>        		
        		<div id="child_flowcontrol" class="sub-child-container expanded">
							<ul class="nav-child">
            	...
            	<a href="javascript:navToggle('timecontrol')" id="link_timecontrol" title="展开" class="blacknounderline" tabindex="1">
              	<img id="img_timecontrol" src="theme/standard/images/expanded.gif" alt="展开" title="展开"/>
              	超时控制
            	</a>
        		</div>        		
        		<div id="child_timecontrol" class="sub-child-container expanded">
							<ul class="nav-child">
        				<li>
        						<a href="sethttptimeout.action" tabindex="1">HTTP超时</a>
								</li>								
        				<li>
										<a href="setsockettimeout.action" tabindex="1">Socket超时</a>
								</li> 								 								
     					</ul>
     				</div>   
        		...
        		<div id="child_ipcontrol" class="sub-child-container expanded">
							<ul class="nav-child">
        				<li>
