...
<table class="detailcontenttable" border="0" cellpadding="0" cellspacing="0" id="detailcontenttable">  
  ...
  <tr>
    <td>
      <form name="addrouteinfo" method="post" action="" id="addrouteinfo" >
      
        <div class="propertiessection" id="propertiessection">
	          <fieldset id="datetimepreferences" title="设置所要控制的消息流">
	            <legend title="设置所要控制的消息流">配置路由</legend>
            	            
	          	<div class="userchoice">
	              <label for="source" title="源路由信息">
	                源路由信息
	              </label>            
	              <br/>
	
	              <input type="text" name="source" id="source" title="填写源路由信息。" tabindex="1" />
	            </div>	            		           						

	            <div class="userchoice">
	  	          <label for="destination" title="目标路由信息">目标路由信息</label>
		            <br/>
		            
								<input type="text" name="destination" id="destination" title="填写目标路由信息。" tabindex="1" />				      																		
	            </div>            
	            
	            <div class="userchoice">
	  	          <label for="description" title="路由描述信息">路由描述</label>
		            <br/>
		            
								<input type="text" name="description" id="description" title="填写路由描述信息。" tabindex="1" />				      																		
	            </div>
	            	            	            								            	
			      </fieldset>						       
									
				    <div class="morespaceabove">				    	
				      <input type="button" name="apply2" value="添加" class="standardbutton" id="navigationapply2" onclick="saveRoute()"/>				                				      
				      <input type="reset" name="apply1" value="重设" class="standardbutton" id="navigationapply1" />				      
						...
						<script language="javascript">  
								...
								function saveRoute(){     	                
								   document.addrouteinfo.action="saveroute.action";  
								   document.addrouteinfo.submit();
								}     							
