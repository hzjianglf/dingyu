...
<!-- Breadcrumb trail -->
<h3 class="breadcrumb" id="title-bread-crumb">创建执行组</h3>
...
<table class="detailcontenttable" border="0" cellpadding="0" cellspacing="0" id="detailcontenttable">  
  ...
  <tr>
    <td>
      <form name="createforeg" method="post" action="createexecutiongroup.action" >
      
        <div class="propertiessection" id="propertiessection">
	          <fieldset id="datetimepreferences" title="创建执行组选项">
	            <legend title="创建执行组选项">设置执行组</legend>
	          	<div class="userchoice">
	              <label for="qmgrname" title="代理队列管理器">
	                代理队列管理器
	              </label>            
	              <br/>
					
	              <input type="text" name="qmgrname" id="qmgrname" title="代理队列管理器。" tabindex="1" value="<s:property value="qmgrname"/>" readonly="readonly"/>
	            </div>
	              ...
	              <input type="text" name="brokername" id="brokername" title="选择所要部署的代理名称。" tabindex="1" value="<s:property value="brokername"/>" readonly="readonly"/>
	            </div>
		           						
	            <div class="userchoice">
	  	          <label for="egname" title="填写所要创建的执行组名称。">执行组名称</label>
		            <br/>

								<input type="text" name="egname" id="egname" title="填写所要创建执行组名称。" tabindex="1" />										
	            </div>
				    ...
				    <div class="morespaceabove">
				      ...
				      <input type="submit" name="apply" value="创建执行组" class="standardbutton" id="navigationapply" />				                
				    </div>
