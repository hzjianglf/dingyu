...
<table class="detailcontenttable" border="0" cellpadding="0" cellspacing="0" id="detailcontenttable">  
  ...
  <tr>
    <td>
      <form name="createtrusted" method="post" action="" id="createtrusted" >
      
        <div class="propertiessection" id="propertiessection">
	          <fieldset id="datetimepreferences" title="设置信任IP地址范围">
	            <legend title="设置信任IP地址范围">配置信任范围</legend>
            	            
	          	<div class="userchoice">
	              <label for="startip" title="起始IP地址">
	                起始IP地址
	              </label>            
	              <br/>
	
	              <input type="text" name="startip" id="startip" title="填写起始IP地址。" tabindex="1" />
	            </div>	            		           						

	            <div class="userchoice">
	  	          <label for="endip" title="结束IP地址">结束IP地址</label>
		            <br/>
		            
								<input type="text" name="endip" id="endip" title="填写结束IP地址" tabindex="1" />				      																		
	            </div>            
	            
	            <div class="userchoice">
	  	          <label for="description" title="描述信息">描述</label>
		            <br/>
		            
								<input type="text" name="description" id="description" title="填写信任IP地址范围描述。" tabindex="1" />				      																		
	            </div>
	            	            	            								            	
			      </fieldset>						       
									
				    <div class="morespaceabove">				    	
				      <input type="button" name="apply2" value="添加" class="standardbutton" id="navigationapply2" onclick="saveTrusted()"/>				                				      
				      <input type="reset" name="apply1" value="重设" class="standardbutton" id="navigationapply1" />				      
						...
						<script language="javascript">  
								...
								function saveTrusted(){     	                
								   document.createtrusted.action="saveipaddress.action";  
								   document.createtrusted.submit();
								}     							
