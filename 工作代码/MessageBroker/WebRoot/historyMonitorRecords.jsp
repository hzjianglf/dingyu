...
<div class="portlet mainwindow" id="collectionview">
  <h2>
    ...
    <span id="collectionviewheading">历史监控</span>
  </h2>
  ...
  <div class="portletbody" id="collectionviewbody">
    <div class="mediumpad" id="collectionviewbodypadding">
			...
			<!-- Breadcrumb trail -->
			<h3 class="breadcrumb" id="title-bread-crumb">历史监控记录</h3>
					<a name="main"></a>
      		<p>
       				用户查看已经归档的历史消息流处理记录。
      		</p>
      		<div id="maincontainer">
		          ...
		          <div class="expandablesection collapsed" id="child_prefsSection">
					...
					<script language="javascript"> 
							function applyRow(){ 
								 ...
								 if (f_check_integer(rows)) {
							   		document.ApplyRow.action="updaterow4history.action";  
					...
					<!-- 展现表格主表 main form -->
					<form name="CollectionForm" method="post" action="searchhistory.action" id="com.ibm.sr.ui.forms.CollectionForm">
				          ...
				          <table id="collection-table" class="collectiontable" cellspacing="1" cellpadding="0" border="0" summary="列表">
				            <tr>
				              ...
				              <th width="10%">
										...
										<s:action name="searchhistory" executeResult="false"></s:action>
		  							<s:iterator value="pageMonitorMainList" status="stat">  
              					...
              					<td width="1%">
              							...
              							<s:elseif test="page==1">
			              					...
			              					<s:if test="totalPage>1">
				              					<td width="1%">
					              					<form name="CollectionForm" method="post" action="searchhistory.action?page=<s:property value="page+1"/>" id="com.ibm.sr.ui.forms.CollectionPagingForm">
					              							<div align="left">
					              									<input type="hidden" value="<s:property value="rowsPerPage"/>" name="rowsPerPage" id="rowsPerPage"/>
