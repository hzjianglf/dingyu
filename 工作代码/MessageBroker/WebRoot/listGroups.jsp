...
<div class="portlet mainwindow" id="collectionview">
  <h2>
    ...
    <span id="collectionviewheading">用户组管理</span>
  </h2>
  ...
  <div class="portletbody" id="collectionviewbody">
    <div class="mediumpad" id="collectionviewbodypadding">
			...
			<!-- Breadcrumb trail -->
			<h3 class="breadcrumb" id="title-bread-crumb">用户组列表</h3>
					<a name="main"></a>
      		<p>
       				查看当前可得的用户组信息。
      		</p>
      		...
      		<div id="maincontainer">
					...
					<!-- 展现表格主表 main form -->
					<form name="registryGroup" method="post" action="" id="com.ibm.sr.ui.forms.CollectionForm">
				            ...
				            <tbody>
					            <tr>
					              <td>	
													<input type="button"  name="regsitry" value="注册用户组" class="standardbutton" id="functions1" tabindex="1" onclick="registry()" />								
													<input type="button"  name="deletegroups" value="删除用户组" class="standardbutton" id="functions2" tabindex="1" onclick="deletegroups()" />													
					              </td>
					            </tr>				
				            </tbody>
				          </table>
							...
							<script language="javascript">  
									...
									function registry(){     	                
									   document.registryGroup.action="";  
									   document.registryGroup.submit();
									}     
				          ...
				          <table id="collection-table" class="collectiontable" cellspacing="1" cellpadding="0" border="0" summary="列表">
				            <tr>
				            		<th id="selectCell" width="1%">
		  							...
		  							<s:iterator value="pageGroupList" status="stat">  
		  	
											<tr>
					              <td width="1%">
										  	  <label class="collectionLabel" title="选择" for="<s:property value="groupname"/>"/>
					             	  
					             	  <input type="checkbox" disabled="true" name="selectedItemIds" tabindex="1" value="<s:property value="groupname"/>" onclick="onItemSelected(this)" onkeypress="onItemSelected(this)" class="noborder nomargin" id="<s:property value="groupname"/>" title="选择">
