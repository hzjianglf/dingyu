...
<div class="portlet mainwindow" id="collectionview">
  <h2>
    ...
    <span id="collectionviewheading">路由配置</span>
  </h2>
  ...
  <div class="portletbody" id="collectionviewbody">
    <div class="mediumpad" id="collectionviewbodypadding">
			...
			<!-- Breadcrumb trail -->
			<h3 class="breadcrumb" id="title-bread-crumb">路由配置</h3>
					<a name="main"></a>
      		<p>
       				可以对于路由信息进行配置和管理。
      		</p>
      		<div id="maincontainer">
					...
					<!-- 展现表格主表 main form -->
					<form name="listrouteinfo" method="post" action="" id="com.ibm.sr.ui.forms.CollectionForm">
				          ...
				          <table class="buttontable" cellspacing="0" cellpadding="0" border="0">				
				            <tbody>
					            <tr>
					              <td>													
					              	<input type="button"  name="create" value="创建路由" class="standardbutton" id="functions1" tabindex="1" onclick="createRoute()" />
					              	<input type="button"  name="modify" value="修改路由" class="standardbutton" id="functions2" tabindex="1" onclick="modifyRoute()" />													
					              	<input type="button"  name="delete" value="删除路由" class="standardbutton" id="functions3" tabindex="1" onclick="deleteRoute()" />																	              	
					              </td>
					            </tr>
				            </tbody>
				          </table>
							...
							<script language="javascript">  		
									...
									function createRoute(){                   
									   document.listrouteinfo.action="addroute.action";  
									   document.listrouteinfo.submit();
									}										

									function modifyRoute(){                   
									   document.listrouteinfo.action="modifyroute.action";  
									   document.listrouteinfo.submit();
									}	
									...
									function deleteRoute(){ 
										 ...
										 if (close) {
									   		document.listrouteinfo.action="deleteroute.action";  
									   		document.listrouteinfo.submit();
									   }		
									}																				 
							</script>
				          ...
				          <table id="collection-table" class="collectiontable" cellspacing="1" cellpadding="0" border="0" summary="列表">
				            <tr>
				              ...
				              <th width="30%" title="目标路由地址">												
													目标路由信息												  
				              </th>
				              <th width="39%" title="路由描述信息">												
													路由描述										  
				              </th>				              			              	              				              		              
										</tr>
		  							...
		  							<s:iterator value="pageRouteList" status="stat">  		  	
											<tr>
					              <td width="1%">
										  	  <label class="collectionLabel" title="选择" for="<s:property value="source"/>"/>
					             	  <input type="checkbox" name="selectedItemIds" tabindex="1" value="<s:property value="source"/>" onclick="onItemSelected(this)" onkeypress="onItemSelected(this)" class="noborder nomargin" id="<s:property value="source"/>" title="选择">
					              </td>
              					...
              					<td width="1%">             							
              							...
              							<s:elseif test="page==1">
		              						...
		              						<s:if test="totalPage>1">
				              					<td width="1%">
					              					<form name="CollectionForm" method="post" action="listrouteinfo.action?page=<s:property value="page+1"/>" id="com.ibm.sr.ui.forms.CollectionPagingForm">
					              							<div align="left">
