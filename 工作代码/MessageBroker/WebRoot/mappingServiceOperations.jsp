    ...
    <div class="mediumpad" id="collectionviewbodypadding">
			...
			<h3 class="breadcrumb" id="title-bread-crumb">服务操作映射</h3>
      		...
      		<div id="maincontainer">					
					...
					<!-- 展现表格主表 main form -->
					<form name="createOperations" method="post" action="" id="com.ibm.sr.ui.forms.CollectionForm">
				          ...
				          <table class="buttontable" cellspacing="0" cellpadding="0" border="0">				
				            <tbody>
					            <tr>
					              <td>
					              	...
					              	<input type="button"  name="create" value="创建操作" class="standardbutton" id="functions1" tabindex="1" onclick="createOperation()" />
													<input type="button"  name="modify" value="修改操作" class="standardbutton" id="functions2" tabindex="1" onclick="modifyOperation()" />																	              	
					              	<input type="button"  name="delete" value="删除操作" class="standardbutton" id="functions3" tabindex="1" onclick="deleteOperation()" />																	              	
					              </td>
							...
							<script language="javascript">  		
									...
									function createOperation(){                   
									   document.createOperations.action="createoperation.action";  
									   document.createOperations.submit();
									}										

									function modifyOperation(){                   
									   document.createOperations.action="modifyoperation.action";  
									   document.createOperations.submit();
									}	
									
									function deleteOperation(){ 
										 var close = confirm("确认删除服务操作？");
										 if (close) {
									   		document.createOperations.action="deleteoperation.action";  
									   		document.createOperations.submit();
									   }		
									}																				 
							</script>
				          ...
				          <table id="collection-table" class="collectiontable" cellspacing="1" cellpadding="0" border="0" summary="列表">
				            <tr>
				              ...
				              <th width="49%" title="业务服务详细描述。">												
	              				...
	              				<td><s:property value="mappingname"/></td>
              					...
              					<td width="1%">             							
              							...
              							<s:elseif test="page==1">
		              						...
		              						<s:if test="totalPage>1">
				              					<td width="1%">
					              					<form name="CollectionForm" method="post" action="mappingoperations.action?page=<s:property value="page+1"/>" id="com.ibm.sr.ui.forms.CollectionPagingForm">
					              							<div align="left">
																					<input type="hidden" value="<s:property value="servicename"/>" name="servicename" id="servicename"/>
													              	<input type="hidden" value="<s:property value="flowname"/>" name="flowname" id="flowname"/>					              						              									
