...
<div class="portlet mainwindow" id="collectionview">
  <h2>
    ...
    <span id="collectionviewheading">修改路由信息</span>
  </h2>
  ...
  <div class="portletbody" id="collectionviewbody">
    <div class="mediumpad" id="collectionviewbodypadding">
			...
			<!-- Breadcrumb trail -->
			<h3 class="breadcrumb" id="title-bread-crumb">路由信息</h3>
					<a name="main"></a>
      		<p>
       				在该页面可以修改ESB的路由信息。
      		</p>     		
      		<div id="maincontainer">
					...
					<!-- 展现表格主表 main form -->
					<form name="modifyrouteinfo" method="post" action="" id="com.ibm.sr.ui.forms.CollectionForm">
				          ...
				          <table class="buttontable" cellspacing="0" cellpadding="0" border="0">				
				            <tbody>
					            <tr>
					              <td>
					              	<input type="hidden" value="<s:property value="source"/>" name="source" id="source"/>
							...
							<script language="javascript"> 
								 	function submitOperation(){ 
										 ...
										 if (close) {
									   		document.modifyrouteinfo.action="savemodifyroute.action";  
									   		document.modifyrouteinfo.submit();
									   }		
									}	
																	
									function cancelOperation(){             
									   document.modifyrouteinfo.action="listrouteinfo.action";  
									   document.modifyrouteinfo.submit();									   
									}	
				          ...
				          <table id="collection-table" class="collectiontable" cellspacing="1" cellpadding="0" border="0" summary="列表">
				            <tr>
				              ...
				              <th width="30%" title="源路由信息">												
													源路由信息																									
				              </th>
				               <th width="30%" title="目标路由信息">												
													目标路由信息												  
				              </th>
				              <th width="39%" title="路由描述">												
												  路由描述	
				              </th>		              				              		              
										</tr>
										
		  							<s:iterator value="pageRouteList" status="stat">  
		  	
											<tr>
					              <td width="1%">
										  	  <label class="collectionLabel" title="选择" for="<s:property value="source"/>" disabled="true" />
					             	  <input type="hidden" name="selectedItemIds" tabindex="1" value="<s:property value="source"/>" onclick="onItemSelected(this)" onkeypress="onItemSelected(this)" class="noborder nomargin" id="<s:property value="source"/>" title="选择">
					              </td>
												<td><span style="width:95%"><s:property value="source"/></span></td>
	              				<td><input style="width:95%" type="text" value="<s:property value="destination"/>" name="destination" id="destination" tabindex="1" /></td>
