...
<script type="text/javascript" src='scripts/navTree.js'></script>
	        ...
	        <div id="brokermonitor" class="main-task">	      	      
	            <a href="javascript:navToggle('brokermonitor')" id="link_brokermonitor" title="折叠" class="blacknounderline" tabindex="1">
	              <img id="img_brokermonitor" src="theme/standard/images/expanded.gif" alt="折叠" title="折叠"/>
	              代理监控
	  	        </a>			      			      
	  			</div>

		      <div id="child_brokermonitor" class="nav-child-container expanded">						
						<div id="monitorrecord" class="sub-task">          
            	<a href="javascript:navToggle('monitorrecord')" id="link_monitorrecord" title="折叠" class="blacknounderline" tabindex="1">
              	<img id="img_monitorrecord" src="theme/standard/images/expanded.gif" alt="折叠" title="折叠"/>
              	监控记录
            	</a>

        		</div>
        		<div id="child_monitorrecord" class="sub-child-container expanded">
							<ul class="nav-child">
        				<li>
            	...
            	<a href="javascript:navToggle('monitorstat')" id="link_monitorstat" title="折叠" class="blacknounderline" tabindex="1">
              	<img id="img_monitorstat" src="theme/standard/images/expanded.gif" alt="折叠" title="折叠"/>
              	统计分析
            	</a>
        		</div>
        		<div id="child_monitorstat" class="sub-child-container expanded">
							<ul class="nav-child">
        				<li>
            	...
            	<a href="javascript:navToggle('wsmonitor')" id="link_wsmonitor" title="折叠" class="blacknounderline" tabindex="1">
              	<img id="img_wsmonitor" src="theme/standard/images/expanded.gif" alt="折叠" title="折叠"/>
              	服务接口监控
            	</a>
        		</div>
        		<div id="child_wsmonitor" class="sub-child-container expanded">
							<ul class="nav-child">
        				<li>
          ...
          <div id="systemmonitor" class="main-task">
                <a href="javascript:navToggle('systemmonitor')" id="link_systemmonitor" title="展开" class="blacknounderline" tabindex="1">
                  <img id="img_systemmonitor" src="theme/standard/images/collapsed.gif" alt="展开" title="展开"/>
                  系统监控
      	        </a>
      		</div>
	      	<div id="child_systemmonitor" class="nav-child-container collapsed">
						<ul class="nav-child">		
						   <li>
