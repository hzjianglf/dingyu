...
<script type="text/javascript" src='scripts/navTree.js'></script>
          ...
          <div id="usermanage" class="main-task">
                <a href="javascript:navToggle('usermanage')" id="link_usermanage" title="折叠" class="blacknounderline" tabindex="1">
                  <img id="img_usermanage" src="theme/standard/images/expanded.gif" alt="折叠" title="折叠"/>
                  安全管理
      	        </a>
      		</div>
	      	<div id="child_usermanage" class="nav-child-container expanded">
						<ul class="nav-child">		
						   <li>
