...
<div class="msgannounce" id="msgannounce" style="display: none;">
  ...
  <div class="msgextra expandablesection collapsed" id="child_extramessages">
    <p id="errorExtraContent"></p>
			...
			<!-- Breadcrumb trail -->
			<h3 class="breadcrumb" id="title-bread-crumb">代理注册</h3>
			
			<a name="main"></a>
		  <p id="detailviewdescription">
		    	在该页面增加所要监控和管理的代理，这是实现监控的第一步。
		  </p>
...
<table class="detailcontenttable fixedlayout" border="0" cellpadding="0" cellspacing="0" id="detailcontenttable">  
  ...
  <tr>
    <td colspan="20">
      <form name="createBrokers" method="post" action="registrybroker.action" id="createBrokers">
        ...
        <div class="propertiessection" id="propertiessection">
          ...
          <div class="expandablesection expanded" id="child_propSection0">
	            <div class="readonlyproperty notmandatory" id="prop_0">
	              <label for="qmgrname" title="注册代理(Broker)的队列管理器名称。" id="label_0">
	                队列管理器名称
	              </label>            
	              <br/>
	
	              <input type="text" name="qmgrname" id="qmgrname" title="注册代理(Broker)的队列管理器名称。" tabindex="1" />    		  	     
	            </div>
    
	            <div class="readonlyproperty notmandatory" id="prop_1">
	              <label for="hostname" title="代理队列管理器所在主机名或IP地址。" id="label_1">
	                主机名或IP地址
	              </label>            
	              <br/>
	
	              <input type="text" name="hostname" id="hostname" title="代理队列管理器所在主机名或IP地址。" tabindex="1" />
	            </div>

	            <div class="readonlyproperty notmandatory" id="prop_2">
	              <label for="port" title="代理队列管理器提供的访问端口。" id="label_2">
	                端口号
	              </label>            
	              <br/>
	
	              <input type="text" name="port" id="port" title="代理队列管理器提供的访问端口。" tabindex="1" />
	            </div>

	            <div class="readonlyproperty notmandatory" id="prop_3">
	              <label for="svrconn" title="代理队列管理器提供的服务器连接通道。" id="label_3">
	                服务器连接通道
	              </label>            
	              <br/>
	
	              <input type="text" name="svrconn" id="svrconn" title="代理队列管理器提供的服务器连接通道。" tabindex="1" />
	            </div>

	            <div class="readonlyproperty notmandatory" id="prop_4">
	              <label for="description" title="代理的描述。指定可以帮助说明代理的任何其他相关信息。" id="label_4">
	                描述
	              </label>            
	              <br/>
	  	    				  	    			
	              <input type="text" name="description" id="description" value="" title="代理的描述。指定可以帮助说明代理的任何其他相关信息。" tabindex="1" />
	            </div>
        ...
        <div class="buttongroup">
	        ...
	        <span id="primarybuttons">
	          <input type="submit" name="submit" value="注册" class="standardbutton" id="navigationsubmit" tabindex="1" onclick="createBroker()"/>	          
	        </span>
					&nbsp;&nbsp;
