  ...
  <div class="portletbody" id="docconfviewbody">
    ...
    <div class="mediumpad" id="docconfviewbodypadding">
      <a name="important"></a> 
			...
			<!-- Breadcrumb trail -->
			<h3 class="breadcrumb" id="title-bread-crumb"><span style="color:Red"><s:property value="message"/></span></h3>
      ...
      <p>
				<span style="color:Red;font-weight:bold"><s:property value="comment2"/></span>
      </p>
      ...
      <div class="buttongroup">
        ...
        <span id="primarybuttons">
        	<form name="return" method="post" action="displayregistryinfo.action" id="com.ibm.sr.ui.forms.CollectionPrefsForm">
          	<input type="submit" name="submit" value="返回注册页面" class="standardbutton" id="navigationsubmit" tabindex="1"/>	
          </form>	          
        </span>
