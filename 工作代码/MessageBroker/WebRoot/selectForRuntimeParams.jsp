...
<!-- Breadcrumb trail -->
<h3 class="breadcrumb" id="title-bread-crumb">运行环境参数</h3>

<a name="main"></a>
	  <p id="detailviewdescription">
	    在该页面用户可以查看和修改代理和执行组的运行环境参数。
	  </p>
...
<script language="javascript">
	...
	function queryBroker(qmgrname){ 
			document.parametersetting.action="selectforruntimebroker.action?qmgrname=" + qmgrname;  
	...
	function viewBroker(){ 
			...
			if (qmgrname!="select") {					
					document.parametersetting.action="viewruntimebroker.action";  
				  document.parametersetting.submit();
			} else {
					alert("必须选择一个代理队列管理器！");					
			}			
	...
	function viewExecutionGroup(){ 
			var qmgrname = document.getElementById("selectedQmgr").value;
			
			if (qmgrname!="select") {									
					document.parametersetting.action="viewruntimeexecutiongroup.action";  
				  document.parametersetting.submit();
			} else {
					alert("必须选择一个代理队列管理器！");					
			}	
      ...
      <form name="parametersetting" method="post" action="">
        ...
        <div class="propertiessection" id="propertiessection">
	          <fieldset id="datetimepreferences" title="查看参数">
	            <legend title="查看选项">选择所要查看的运行环境参数</legend>
	            ...
	            <div class="userchoice">
	  	          <label for="brokerruntimeparamlist" title="选择所要查看的代理运行环境参数。">代理运行环境参数</label>
		            <br/>
		            
		            <select name="brokerRuntimeParam" id="brokerRuntimeParam" >            						
										<option value="HTTPConnector" selected="selected">HTTPConnector&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>
										<option value="HTTPListener" >HTTPListener&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>
										<option value="HTTPSConnector" >HTTPSConnector&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>
								</select>
										
	            </div>
	            		           						
	            <div class="userchoice">
	  	          <label for="calendarlist" title="选择所要查看的执行组。">执行组名称</label>
		            <br/>
		            
		            <select name="selectedExecutionGroup" id="selectedExecutionGroup" >
		            		
	            			<s:iterator value="egMap" id="executiongroup" status="order">	            						
												<option value="<s:property value="#executiongroup.key"/>" ><s:property value="#executiongroup.value"/> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>												
										</s:iterator>	
								</select>
	            ...
	            <div class="userchoice">
	  	          <label for="egRuntimeparamlist" title="选择所要查看的执行组运行环境参数。">执行组运行环境参数</label>
		            <br/>
		            
		            <select name="egRuntimeParam" id="egRuntimeParam" >            						
										<option value="ComIbmDatabaseConnectionManager" >ComIbmDatabaseConnectionManager&nbsp;&nbsp;&nbsp;</option>
										<option value="ComIbmJVMManager" selected="selected" >ComIbmJVMManager&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>
										<option value="ComIbmMQConnectionManager" >ComIbmMQConnectionManager&nbsp;&nbsp;&nbsp;</option>
										<option value="ComIbmSocketConnectionManager" >ComIbmSocketConnectionManager&nbsp;&nbsp;&nbsp;</option>										
								</select>
				    ...
				    <div class="morespaceabove">				    	
				      <input type="submit" name="apply1" value="查看代理参数" class="standardbutton" id="navigationapply1" onclick="viewBroker()"/>				                
				      <input type="submit" name="apply2" value="查看执行组参数" class="standardbutton" id="navigationapply2" onclick="viewExecutionGroup()"/>				      
				    </div>
