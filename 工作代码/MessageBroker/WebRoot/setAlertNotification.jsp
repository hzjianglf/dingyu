...
<div class="msgannounce" id="msgannounce" style="display: none;">
  ...
  <div class="msgextra expandablesection collapsed" id="child_extramessages">
    <p id="errorExtraContent"></p>
			...
			<!-- Breadcrumb trail -->
			<h3 class="breadcrumb" id="title-bread-crumb">页面说明</h3>
			
			<a name="main"></a>
		  <p id="detailviewdescription">
		    	在该页面配置告警通知相关参数，包括了Email服务器地址和MQ服务器地址等。
		  </p>
		  <br/>
...
function handleSubmit(evt)
{
  ...
  <tr>
    <td colspan="20">
      <form name="setnotification" method="post" action="" id="setnotification" focus="" onsubmit="return handleSubmit(event)">
        ...
        <div class="propertiessection" id="propertiessection">
          ...
          <div class="expandablesection expanded" id="child_propSection0">
	            <div class="readonlyproperty notmandatory" id="prop_0">
	              <label for="smtpserver" title="发送告警信息的SMTP服务器地址" id="label_0">
	                SMTP服务器地址
	              </label>            
	              <br/>
	
	              <input type="text" name="smtpserver" id="smtpserver" title="发送告警信息的SMTP服务器地址。" tabindex="1" onfocus="handleFocus()" onkeypress="return handleKeypress(event)" value="<s:property value="smtpserver"/>"/>    		  	     
	            </div>
	            
	            <div class="readonlyproperty notmandatory" id="prop_2">
	              <label for="emailid" title="发送告警信息的Email用户名" id="label_2">
	                Email发送用户名
	              </label>            
	              <br/>
	
	              <input type="text" name="emailid" id="emailid" title="发送告警信息的Email用户名。" tabindex="1" value="<s:property value="emailid"/>"/>    		  	     
	            </div>
	            
	            <div class="readonlyproperty notmandatory" id="prop_3">
	              <label for="emailpwd" title="发送告警信息的Email密码" id="label_3">
	                Email发送密码
	              </label>            
	              <br/>
	
	              <input type="password" name="emailpwd" id="emailpwd" title="发送告警信息的Email密码。" tabindex="1" value="<s:property value="emailpwd"/>"/>    		  	     
	            </div>	            	        	            
          </div>
          ...
          <div class="sectiondivider" id="propSection1">
            ...
            <div class="expandablesection expanded" id="child_propSection1">
	            <div class="readonlyproperty notmandatory" id="prop_0">
	              <label for="qmgrname" title="队列管理器名称" id="label_0">
	                MQ队列管理器名称
	              </label>            
	              <br/>
	
	              <input type="text" name="qmgrname" id="qmgrname" title="队列管理器名称" tabindex="1" onfocus="handleFocus()" onkeypress="return handleKeypress(event)" value="<s:property value="qmgrname"/>"/>    		  	     
	            </div>
	            
	            <div class="readonlyproperty notmandatory" id="prop_1">
	              <label for="connectionmode" title="选择MQ服务器的连接方式" id="label_1">
	                MQ连接方式
	              </label>            
	              <br/>
	
	              <select name="connectionmode" id="connectionmode">
          	      <s:if test="connectionmode=='2'.toString()"> 																		              				
          						<option value="1">绑定模式</option>
											<option selected="selected" value="2">客户端模式</option>
          				</s:if>
          				<s:else>
			              	<option selected="selected" value="1">绑定模式</option>
	            ...
	            <div class="readonlyproperty notmandatory" id="prop_2">
	              <label for="mqhostname" title="采用客户端模式，填写MQ服务器IP地址" id="label_2">
	                MQ服务器地址
	              </label>            
	              <br/>
	
	              <input type="text" name="mqhostname" id="mqhostname" title="采用客户端模式，填写MQ服务器IP地址。" tabindex="1" value="<s:property value="mqhostname"/>"/>
	            </div>

	            <div class="readonlyproperty notmandatory" id="prop_3">
	              <label for="mqport" title="采用客户端模式，填写MQ服务器端口号" id="label_3">
	                MQ服务器端口号
	              </label>            
	              <br/>
	
	              <input type="text" name="mqport" id="mqport" title="采用客户端模式，填写MQ服务器端口号。" tabindex="1" value="1414" value="<s:property value="mqport"/>"/>
	            </div>
	            
	            <div class="readonlyproperty notmandatory" id="prop_4">
	              <label for="mqchannel" title="采用客户端模式，填写MQ服务器连接通道" id="label_4">
	                MQ服务器连接通道
	              </label>            
	              <br/>
	
	              <input type="text" name="mqchannel" id="mqchannel" title="采用客户端模式，填写MQ服务器连接通道。" tabindex="1" value="SYSTEM.DEF.SVRCONN" value="<s:property value="mqchannel"/>"/>																											
	            </div>
        ...
        <div class="buttongroup">
	        ...
	        <span id="primarybuttons">
	          <input type="button" name="save" value="保存" class="standardbutton" id="navigationsubmit" tabindex="1" onclick="saveNotification()"/>	          
	        </span>
					&nbsp;&nbsp;
				...
				<script language="javascript"> 
						function saveNotification(){ 							
							document.setnotification.action="savenotification.action";
					   	document.setnotification.submit();
						}
