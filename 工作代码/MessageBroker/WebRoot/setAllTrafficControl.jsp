...
<!-- Breadcrumb trail -->
<h3 class="breadcrumb" id="title-bread-crumb">总量控制</h3>
...
<table class="detailcontenttable" border="0" cellpadding="0" cellspacing="0" id="detailcontenttable">  
  ...
  <tr>
    <td>
      <form name="allcontrolsetting" method="post" action="" id="allcontrolsetting" >
      
        <div class="propertiessection" id="propertiessection">
	          <fieldset id="datetimepreferences" title="设置控制参数">
	            <legend title="设置控制参数">设置总量控制参数</legend>
            		           						
	            <div class="userchoice">
	  	          <label for="allinterval" title="流量控制时间间隔">单位时间间隔</label>
		            <br/>
		            
								<input type="text" name="allinterval" id="allinterval" title="填写流量控制时间间隔。" tabindex="1" value="<s:property value="allinterval"/>"/>				      																		
	            </div>
	            
	            <div class="userchoice">
	              <label for="allunit" title="时间间隔单位">
	                时间间隔单位
	              </label>            
	              <br/>
	
	              <select name="allunit" id="allunit">
	              		<s:if test="allunit=='2'.toString()"> 
				              	<option value="1">秒 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>
												<option selected="selected" value="2">分钟 &nbsp;&nbsp;&nbsp;&nbsp;</option>
												<option value="3">小时 &nbsp;&nbsp;&nbsp;&nbsp;</option>
										</s:if>
	          				<s:elseif test="allunit=='3'.toString()">
				              	<option value="1">秒 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>
												<option value="2">分钟 &nbsp;&nbsp;&nbsp;&nbsp;</option>
												<option selected="selected" value="3">小时 &nbsp;&nbsp;&nbsp;&nbsp;</option>
										</s:elseif>
										<s:else>
	            ...
	            <div class="userchoice">
	  	          <label for="allthreshold" title="单个消息流的流量阈值">流量阈值</label>
		            <br/>
		            
								<input type="text" name="allthreshold" id="allthreshold" title="填写单个消息流的流量阈值。" tabindex="1" value="<s:property value="allthreshold"/>"/>				      																		
	            </div>
	            	            	            								            	
			      </fieldset>						       
									
				    <div class="morespaceabove">				    	
				      <input type="button" name="save" value="保存" class="standardbutton" id="navigationapply2" onclick="saveAllControl()"/>				                				      
				      <input type="reset" name="reset" value="重设" class="standardbutton" id="navigationapply1" />				      
				    </div>
						...
						<script language="javascript">
							...
							function saveAllControl(){ 
									document.allcontrolsetting.action="savealltrafficcontrol.action";  
								  document.allcontrolsetting.submit();
							}  
