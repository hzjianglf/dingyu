...
<!-- Breadcrumb trail -->
<h3 class="breadcrumb" id="title-bread-crumb">设置实例数</h3>
...
<table class="detailcontenttable" border="0" cellpadding="0" cellspacing="0" id="detailcontenttable">  
  ...
  <tr>
    <td>
      <form name="createforeg" method="post" action="setadditionalinstances.action" >
      
        <div class="propertiessection" id="propertiessection">
	          <fieldset id="datetimepreferences" title="设置实例数选项">
	            <legend title="设置实例数选项">设置实例数</legend>
	          	<div class="userchoice">
	              <label for="brokername" title="代理">
	                代理名称
	              </label>            
	              <br/>
	
	              <input type="text" name="brokername" id="brokername" title="代理" tabindex="1" value="<s:property value="brokername"/>" readonly="readonly"/>
	            </div>

	          	<div class="userchoice">
	              <label for="egname" title="执行组名称">
	                执行组名称
	              </label>            
	              <br/>
	
	              <input type="text" name="egname" id="egname" title="执行组名称" tabindex="1" value="<s:property value="egname"/>" readonly="readonly"/>
	            </div>
	                 	<div class="userchoice">
	              <label for="msgflowname" title="消息流名称。">
	                消息流名称
	              </label>            
	              <br/>
	
	              <input type="text" name="flowname" id="flowname" title="消息流名称" tabindex="1" value="<s:property value="flowname"/>" readonly="readonly"/>
	            </div>
		           						
	            <div class="userchoice">
	  	          <label for="instances" title="填写所要设置实例数量。">实例数</label>
		            <br/>

								<input type="text" name="instances" id="instances" title="填写所要设置实例数量。" tabindex="1" value="<s:property value="instances"/>" />										
	            </div>
								            	
			      </fieldset>        
									
				    <div class="morespaceabove">				    	
				      <input type="submit" name="apply" value="设置实例数" class="standardbutton" id="navigationapply" />				                
				    </div>
