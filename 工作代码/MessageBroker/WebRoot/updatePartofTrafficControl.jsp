...
<title>WebSphere Message Broker 控制台 Update</title>
...
<a name="main"></a>
	  <p id="detailviewdescription">
	    在该页面用户可以以消息流为单位，单独设置每一个消息流的流量控制。
	  </p>
...
<table class="detailcontenttable" border="0" cellpadding="0" cellspacing="0" id="detailcontenttable">  
  ...
  <tr>
    <td>
      <form name="partofcontrolsetting" method="post" action="" id="partofcontrolsetting" >
      
        <div class="propertiessection" id="propertiessection">
	          <fieldset id="datetimepreferences" title="设置所要控制的消息流">
	            <legend title="设置所要控制的消息流">设置所要控制的消息流</legend>
            	            
	          	<div class="userchoice">
	              <label for="flowname" title="所要控制的消息流名称。">
	                消息流名称
	              </label>            
	              <br/>
	
	              <input readonly type="text" name="flowname" id="flowname" title="填写所要进行流量控制的消息流名称。" tabindex="1" value="<s:property value="flowname"/>" />
	            </div>	            		           						

	            <div class="userchoice">
	  	          <label for="partofinterval" title="流量控制时间间隔">单位时间间隔</label>
		            <br/>
		            
								<input readonly type="text" name="partofinterval" id="partofinterval" title="填写流量控制时间间隔。" tabindex="1" value="<s:property value="partofinterval"/>" />	      																		
	            </div>
	            
	            <div class="userchoice">
	              <label for="partofunit" title="时间间隔单位">
	                时间间隔单位
	              </label>            
	              <br/>
	
	              <select readonly name="partofunit" id="partofunit">
		              	<option value="1">秒 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>
										<option selected="selected" value="2">分钟 &nbsp;&nbsp;&nbsp;&nbsp;</option>
										<option value="3">小时 &nbsp;&nbsp;&nbsp;&nbsp;</option>
								</select>																												
	            </div>	            
	            
	            <div class="userchoice">
	  	          <label for="partofthreshold" title="单个消息流的流量阈值">流量阈值</label>
		            <br/>
		            
								<input type="text" name="partofthreshold" id="partofthreshold" title="填写单个消息流的流量阈值。" tabindex="1" value="<s:property value="partofthreshold"/>" />		      																		
	            </div>
	            	            	            								            	
			      </fieldset>						       
									
				    <div class="morespaceabove">				    	
				      <input type="button" name="apply2" value="修改" class="standardbutton" id="navigationapply2" onclick="createConfigService()"/>				                				      
				      <input type="reset" name="apply1" value="重设" class="standardbutton" id="navigationapply1" />				      
				    </div>
						...
						<script language="javascript">  
								...
								function createConfigService(){     	                
								   document.partofcontrolsetting.action="updatePartOfControl.action";  
								   document.partofcontrolsetting.submit();
								}     							
