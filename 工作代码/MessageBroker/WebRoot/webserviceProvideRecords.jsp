...
<div class="portlet mainwindow" id="collectionview">
  <h2>
    ...
    <span id="collectionviewheading">服务提供</span>
  </h2>
  ...
  <div class="portletbody" id="collectionviewbody">
    <div class="mediumpad" id="collectionviewbodypadding">
			...
			<!-- Breadcrumb trail -->
			<h3 class="breadcrumb" id="title-bread-crumb">服务提供</h3>
					<a name="main"></a>
      		<p>
       				在该页面可以查看到ESB(Message Broker)对外提供服务的调用信息。
      		</p>
      		<div id="maincontainer">				

					<!-- 展现表格主表 main form -->
					<form name="CollectionForm" method="post" action="searchwsprovide.action" id="com.ibm.sr.ui.forms.CollectionForm">
				          ...
				          <table id="collection-table" class="collectiontable" cellspacing="1" cellpadding="0" border="0" summary="列表">
				            <tr>
				              ...
				              <th width="23%" title="消息代理对外提供服务名称。">												
													ESB提供的服务名称
				              </th>
				               <th width="13%">												
													最大响应时间 (毫秒)												  
				              ...
				              <th width="11%">
		  							...
		  							<s:iterator value="pageWSProvideList" status="stat">  
              					...
              					<td width="1%">             							
              							...
              							<s:elseif test="page==1">
		              						...
		              						<s:if test="totalPage>1">
				              					<td width="1%">
					              					<form name="CollectionForm" method="post" action="searchwsprovide.action?page=<s:property value="page+1"/>" id="com.ibm.sr.ui.forms.CollectionPagingForm">
					              							<div align="left">
		        ...
		        <!-- 展现表格主表 main form -->
					<form name="CountForm" method="post" action="searchwsprovide.action" id="com.ibm.sr.ui.forms.CollectionForm">
		                ...
		                <td width="100%">
				          ...
				          <table id="collection-table" class="collectiontable" cellspacing="1" cellpadding="0" border="0" summary="列表">
				            <tr>
				              ...
				              <th width="13%" title="消息代理对外提供服务类型总数。">												
													ESB提供服务总数
				              </th>
				               <th width="16%">												
													总体最大响应时间 (毫秒)												  
				              ...
				              <th width="16%">
		  							...
		  							<s:iterator value="totalWSProvideList" status="stat">  
		  	
											<tr>
					              <td width="3%">1</td>
												<td><s:property value="wsprovidenumber"/></td>
	              				<td><s:property value="maxproctime"/></td>
	              				<td><s:property value="minproctime"/></td>
	              				<td><s:property value="avgproctime"/></td>
	              				<td><s:property value="successnumber"/></td>
