...
public class ThirdpartyServiceRepository extends AbstractServiceRepository
{
  private Map<String, ServiceDefinition> serviceDefinitions = new ConcurrentHashMap();

  public ThirdpartyServiceRepository() {
