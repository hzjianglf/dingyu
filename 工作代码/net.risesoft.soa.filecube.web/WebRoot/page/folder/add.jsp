            ...
            {    
                ...
                if(folderForm.getForm().isValid()){
                	folderForm.getForm().doAction('submit',{
                        url:'folder_add.action' ,//文件路径
                        method:'post',//提交方法post或get 
						params:'folder.parentUid=${parentFolderUid}&folderTreeType=' + global_FOLDER_TREE_TYPE_CUR,  
						waitMsg:'正在保存，请稍后……',
                        //提交成功的回调函数
                        success:function(form,action){                        	
                            ...
                            if (msg != 'error') {                                                         
                                ...
                                Ext.getCmp('folderName').setValue("");
                    			Ext.getCmp('folderDes').setValue("");
                            } else {
                                Ext.Msg.alert('操作错误',msg);
                            }   
                            popWin.close();
                            _left_refreshTreeAndList('${parentFolderUid}');
                        },
                        //提交失败的回调函数
                        failure:function(){
