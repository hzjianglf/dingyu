  ...
  <tr>
  	<td height="100%">
  		...
  		<tr>
  			...
  			<td valign=top style="background-color: #ffffff; border:1px solid #ccd0d0; border-radius: 5px; -moz-border-radius:5px; -webkit-border-radius:5px;"><div id="infoShow_div"></div></td>
  		</tr>
  		</table>
  	</td>
  </tr>
