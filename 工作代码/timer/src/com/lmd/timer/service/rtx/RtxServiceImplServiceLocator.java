...
public class RtxServiceImplServiceLocator extends org.apache.axis.client.Service implements com.lmd.timer.service.rtx.RtxServiceImplService {
    ...
    public com.lmd.timer.service.rtx.RtxService getRtxServiceImplPort() throws javax.xml.rpc.ServiceException {
    ...
    public com.lmd.timer.service.rtx.RtxService getRtxServiceImplPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.lmd.timer.service.rtx.RtxServiceImplServiceSoapBindingStub _stub = new com.lmd.timer.service.rtx.RtxServiceImplServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.lmd.timer.service.rtx.RtxService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.lmd.timer.service.rtx.RtxServiceImplServiceSoapBindingStub _stub = new com.lmd.timer.service.rtx.RtxServiceImplServiceSoapBindingStub(new java.net.URL(RtxServiceImplPort_address), this);
                _stub.setPortName(getRtxServiceImplPortWSDDServiceName());
                return _stub;
            }
        }
