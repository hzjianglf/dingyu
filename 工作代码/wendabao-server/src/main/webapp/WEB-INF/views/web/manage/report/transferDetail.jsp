...
<div class="container" style="width:100%;">
    <div class="row" style="border:0;margin-top:-10px;">
        <div class="col-sm-12">
            <h3 class="zs-iframe-title">划款清单详情</h3>
        </div>
    </div>
    <div class="row" style="margin-top:10px;">
        ...
        <div class="col-sm-4"  style="padding-left:0px;">
            <label for="timeStr" style=" padding-top:7px;">划款单截至时间：</label><span id="timeStr"></span>
        </div>
    ...
    <div class="row" style="margin-top:10px;" id="transferAllBtn" hidden>
        <div class=" col-sm-12" align="right">
            <button type="button" class="btn btn-default zs-btn-green" onclick="transferNow('ALL')">全部划款</button>
        </div>
    </div>
</div>
    ...
    function queryTransferDetail(){
        ...
        sendRequest({"transfer_time":date,"shopId":shopId},"/bm/order/queryTransferDetail.do",function(json){
            ...
            $(json.list).each(function(i,ite){
                ...
                $("#timeStr").text(ite.transfer_oper_time);
