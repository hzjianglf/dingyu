...
#lottery .arrow { background: url("/wxpt/manager/images/zhizhen.png?v=1bde2") no-repeat scroll 0 0 transparent; height: 243px; left: 277px; position: absolute; top: 200px; width: 61px; }
#lottery .lot-btn { height: 92px; left: 260px; overflow: hidden; position: absolute; top: 350px; width: 91px; }
...
<div id="layer" style="position:absolute; top:870px; left:30%; z-index: 100;">
  <p></p>
...
<s:iterator value="imagerollList" var="imageroll">
...
$(".lot-btn").click(function() {
	...
	$.ajax({
		type : "POST",
		url : '<%=basePath%>site/roll!toLuck1',
		data : {
