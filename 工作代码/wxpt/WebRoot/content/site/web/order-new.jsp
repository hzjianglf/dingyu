...
<ul class="buyer_stat" style="margin-top: 10px;">
    	<li class="btn_1 active"><a href="../../site/web/order!getAllNewOrder">待付款</a><span>待付款</span></li>        
...
function firstpage(){
			...
			$.ajax({
				type : "POST",
				url : "/wxpt/site/web/order!getChangeNewPage",
				data : {
					'currentpage' : curPage
				},
          		...
          		<div class="order_form">
                    ...
                    <div class="foot">
                        <p class="time">添加时间: <s:property value="#lo3.order.orderTime"/></p>
                            ...
                            <a href="javascript:getFukuan(<s:property value='#lo3.order.orderNum'/>)" target="_blank" id="order402_action_pay" class="btn" style="color:red;">付款</a>
                            <a href="../../site/web/order!getCannelOrder?ordernum=<s:property value='#lo3.order.orderNum'/>" id="order402_action_cancel"> 取消订单</a>
