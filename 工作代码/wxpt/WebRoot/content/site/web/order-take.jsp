...
<ul class="buyer_stat" style="margin-top: 10px;">
        ...
        <li class="btn_3 active"><a href="../../site/web/order!getAllTakeOrder">待收货</a><span>待收货</span></li>
...
function firstpage(){
			...
			$.ajax({
				type : "POST",
				url : "/wxpt/site/web/order!getChangeTakePage",
				data : {
					'currentpage' : curPage
				},
          		...
          		<div class="order_form">
                    ...
                    <div class="foot">
                        <p class="time">添加时间: <s:property value="#lo3.order.orderTime"/></p>
                            ...
                            <a href="../../site/web/order!getEnterOrder?ordernum=<s:property value='#lo3.order.orderNum'/>" id="order402_action_confirm" style="color:red;">确认收货</a>
