/******************************************
 * Websanova.com                /mdouyou/web/images/'+$("#fileName").val()
 *
...
(function($)
{
	...
	new_image.src = '/wxpt/web/images/'+$("#fileName").val();
	...
	$.fn.wScratchPad.defaultSettings =
	{
			...
			height			: 350,					// set height - best to match image height
			image			: '/wxpt/web/images/'+$("#fileName").val(),			// set image path
