$(function(){
 ...
 $('#order').datagrid({
    ...
    url:'../site/baidu!getAll?type=6',
    loadMsg:'数据装载中......',
    sortName:'code',
    sortOrder:'desc',
    remoteSort:false,
    columns:[[
     {title:'受访页面',field:'page',width : 290,rowspan:2,align:'center'},
     {title:'域名',field:'domain',width : 180,rowspan:2,align:'center'},
     {title:'浏览量',field:'pageviews',width : 70,rowspan:2,align:'center'},
     {title:'访客数',field:'visitors',width : 70,rowspan:2,align:'center'},
     {title:'ip数',field:'ips',width : 60,rowspan:2,align:'center'},
     {title:'入口页次数',field:'entrances',width : 70,rowspan:2,align:'center'},
     {title:'贡献下游流量',field:'outwards',width : 90,rowspan:2,align:'center'},
     {title:'退出页次数',field:'exits',width : 70,rowspan:2,align:'center'},
     {title:'平均停留时间',field:'stayTime',width : 100,rowspan:2,align:'center'},
     {title:'退出率',field:'exitRate',width : 70,rowspan:2,align:'center'},
//     {title:'用户Id',field:'userId',width : 80,rowspan:2,align:'center'},
     {title:'统计日期',field:'recordTime',width : 100,rowspan:2,align:'center'},
    ]],
    rownumbers:true,
    pagination:true,
    rownumbers:true,
