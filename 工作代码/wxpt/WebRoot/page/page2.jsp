...
<body id="activity-detail">
	<div class="page-bizinfo">
		<div class="header">
			<h1 id="activity-name"><s:property value="page.PageTitle"/></h1>
			<p class="activity-info">
				<span id="post-date" class="activity-meta no-extra"><s:property value="page.pageTime"/></span>
				<s:if test="page.pageAuthor!='null'">
				<span class="activity-meta"><s:property value="page.pageAuthor"/></span>
				</s:if>
				 <a href="javascript:;"
					id="post-user" class="activity-meta"> <span
					class="text-ellipsis"><s:property value="page.pageNoName"/></span><i class="icon_link_arrow"></i> </a>
			</p>
		</div>
	</div>
	<div class="page-content">
		<div class="media" id="media">
			<img
				src="<%=filePath %>/<s:property value="page.pageImage"/>"
				onerror="this.parentNode.removeChild(this)"
				data-src="<%=filePath %>/<s:property value="page.pageImage"/>" />
		</div>
		<div class="text">
...
var sourceurl = trim('http://quan.qgc.qq.com/121815207#wechat_redirect'.replace(/&lt;/g, '<').replace(/&gt;/g, '>'));
    ...
    var query = [
            ...
            location.href = '/mp/readtemplate?t=wxm-appmsg-inform&__biz=MTA3NDM1MzUwMQ==&info=' + encodeURIComponent(query) + "#wechat_redirect";
    }
...
(function(){
        ...
        function onBridgeReady() {
            var appId  = '',
    imgUrl = "<%=filePath %>/<s:property value="page.pageImage"/>",
