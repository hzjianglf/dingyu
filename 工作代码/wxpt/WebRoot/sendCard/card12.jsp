...
<div style="background:url(<%=filePath%>/<s:property value="card.cardBgImage"/>) no-repeat; background-size:100% 100%; margin:0; padding:0;">
	...
	<div class="sd12">
		<textarea class="test test12" id="s_content"><s:property value="card.cardValue" /></textarea>
		<input type="text" value="<s:property value="enterName"/>" class="inp inp12" id="f_name"/>
...
<div style="margin-top:5%;" id="send_image">
	<img src="images/fs3.png" style="width:100%;">
</div> 
