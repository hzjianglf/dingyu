...
<div style="background:url(<%=filePath%>/<s:property value="card.cardBgImage"/>) no-repeat; background-size:100% 100%; margin:0; padding:0;">
	...
	<div class="sd3">
		<textarea class="test test3" id="s_content"><s:property value="card.cardValue" /></textarea>
		<input type="text" value="<s:property value="enterName"/>" class="inp inp2" id="f_name"/>
		<input type="text" value="<s:property value="time"/>" class="inp inp2" disabled="disabled"/>
	</div>
</div>
<div style="margin-top:5%;" id="send_image">
	<img src="images/fs5.png" style="width:100%;">
</div> 
