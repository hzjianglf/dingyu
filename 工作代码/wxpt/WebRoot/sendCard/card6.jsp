...
<div style="background:url(<%=filePath%>/<s:property value="card.cardBgImage"/>) no-repeat; background-size:100% 100%; margin:0; padding:0;">
	...
	<div class="sd6">
		<textarea class="test test6" id="s_content"><s:property value="card.cardValue" /></textarea>
		<input type="text" value="<s:property value="enterName"/>" class="inp inp6" id="f_name"/>
