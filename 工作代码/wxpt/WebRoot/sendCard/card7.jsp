...
<div style="background:url(<%=filePath%>/<s:property value="card.cardBgImage"/>) no-repeat; background-size:100% 100%; margin:0; padding:0;">
	...
	<div class="sd7">
		<textarea class="test test7" id="s_content"><s:property value="card.cardValue" /></textarea>
	</div>
	<div class="sd7-1">
		<input type="text" value="<s:property value="enterName"/>" class="inp inp7" id="f_name"/>
