...
<div style="background:url(<%=filePath%>/<s:property value="card.cardBgImage"/>) no-repeat; background-size:100% 100%; margin:0; padding:0;">
	...
	<div class="sd9">
		<textarea class="test test9" id="s_content"><s:property value="card.cardValue" /></textarea>
		<input type="text" value="<s:property value="enterName"/>" class="inp inp9" id="f_name"/>
