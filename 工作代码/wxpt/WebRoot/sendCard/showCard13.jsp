...
<div style="background:url(<%=filePath%>/<s:property value="card.cardBgImage"/>) no-repeat; background-size:100% 100%; margin:0; padding:0;">
	<div class="sd13">
		<textarea class="test test13" id="s_content"><s:property value="cardPojo.cardValue" /></textarea>
	    <input type="text" value="<s:property value="fromUser"/>" class="inp inp13" id="f_name" disabled="disabled"/>
