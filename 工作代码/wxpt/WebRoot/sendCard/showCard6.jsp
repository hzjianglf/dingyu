...
<div style="background:url(<%=filePath%>/<s:property value="card.cardBgImage"/>) no-repeat; background-size:100% 100%; margin:0; padding:0;">
	<div class="sd6">
		<textarea class="test test6" id="s_content" ><s:property value="cardPojo.cardValue"  /></textarea>
		<input type="text" value="<s:property value="fromUser"/>" class="inp inp6" id="f_name" disabled="disabled" style="margin-top:20px;"/>
		<input type="text" value="<s:property value="time"/>" class="inp inp6" disabled="disabled"/>
	</div>
</div>
