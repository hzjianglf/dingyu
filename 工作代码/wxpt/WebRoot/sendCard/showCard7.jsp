...
<div style="background:url(<%=filePath%>/<s:property value="card.cardBgImage"/>) no-repeat; background-size:100% 100%; margin:0; padding:0;">
	<div class="sd7">
		<textarea class="test test7" id="s_content"><s:property value="cardPojo.cardValue" /></textarea>
	</div>
	<div class="sd7-1"><input type="text" value="<s:property value="fromUser"/>" class="inp inp7" id="f_name" disabled="disabled" style="margin-top:20px;"/>
		<input type="text" value="<s:property value="time"/>" class="inp inp7" disabled="disabled"/>
	</div>
</div>
<div style="margin-top:5%;" >
	<img src="images/fs2.png" style="width:100%;" id="send_show_image">
