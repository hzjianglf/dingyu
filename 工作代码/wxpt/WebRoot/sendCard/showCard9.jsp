...
<div style="background:url(<%=filePath%>/<s:property value="card.cardBgImage"/>) no-repeat; background-size:100% 100%; margin:0; padding:0;">
	<div class="sd9">
		<textarea class="test test9" id="s_content"><s:property value="cardPojo.cardValue" /></textarea>
	    <input type="text" value="<s:property value="fromUser"/>" class="inp inp9" id="f_name" disabled="disabled"/>
		<input type="text" value="<s:property value="time"/>" class="inp inp9" disabled="disabled"/>
	</div>
</div>
