...
<body id="activity-detail">
	...
	<script type="text/javascript">
        ...
        var title     = trim('圣诞节涨姿势，iPhone5s、iPadmini 等你拿！'     .replace(/&lt;/g, '<').replace(/&gt;/g, '>'));
        var sourceurl = trim('http://mp.weixin.qq.com/mp/appmsg/show?__biz=MjM5ODAzMjQwMA==&appmsgid=100221487&itemidx=1&sign=451a7dc85aa1dfae19a368470cdb92f9#wechat_redirect'.replace(/&lt;/g, '<').replace(/&gt;/g, '>'));
