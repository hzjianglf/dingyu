...
<div style="width:100%; height:45px; background:#84d1f9;">
	<span style="margin-left:15px; font-weight:bold; font-size:36px; color:#FFF;"><s:property value="menuName" /></span>
</div>
...
<div class="yincang" id="div1" style="display:block">
	<s:iterator value="pageList" var="pageAbout">
		<img src="<%=filePath%>/<s:property value="#pageAbout.metaImageValue"/>" id="divImage"/>
	</s:iterator>
</div>
		...
		$.ajax({
			...
			success : function(date){
				...
				for(var i = 0;i<jsons.length;i++){
					str +="<img src=\"<%=filePath%>/"+jsons[i].metaImageValue+"\"/>";
				}
				$("#div1").html(str);
			},
			error: function() { 
